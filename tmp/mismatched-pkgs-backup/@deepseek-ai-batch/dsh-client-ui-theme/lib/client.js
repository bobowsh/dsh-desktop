window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		//#endregion
		//#region \0dsh-css:/private/tmp/claude-501/-Users-alex-Documents-Code-dataelem-dsh-desktop/8cafdb41-dc87-41ba-bba5-9afd99a08420/scratchpad/harness/packages/client/ui-theme/src/client/AppearanceRow.module.css.mjs
		const css$1 = "._5nGS1W_group{border-bottom:1px solid var(--dsw-alias-border-l2);flex-direction:column;gap:8px;padding:16px 0;display:flex}._5nGS1W_title{color:var(--dsw-alias-label-primary);font-size:14px;font-weight:400;line-height:22px}._5nGS1W_cubeRow{flex-wrap:wrap;align-items:stretch;gap:8px;display:flex}._5nGS1W_themeCube{box-sizing:border-box;border:1px solid var(--dsw-alias-border-l2);font:inherit;color:var(--dsw-alias-label-primary);cursor:pointer;background:0 0;border-radius:16px;flex-direction:column;flex:180px;justify-content:center;align-items:center;gap:4px;padding:20px 32px;font-size:14px;line-height:22px;display:flex}._5nGS1W_themeCube:hover:not(._5nGS1W_selected){background:var(--dsw-alias-interactive-bg-hover)}._5nGS1W_selected{background:var(--dsw-alias-bg-module-platform);border-color:var(--dsw-static-neutral-bluish-400)}";
		...
		var AppearanceRow_module_css_default = {
			"cubeRow": "_5nGS1W_cubeRow",
			"group": "_5nGS1W_group",
			"selected": "_5nGS1W_selected",
			"themeCube": "_5nGS1W_themeCube",
			"title": "_5nGS1W_title"
		};
		//#endregion
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:/private/tmp/claude-501/-Users-alex-Documents-Code-dataelem-dsh-desktop/8cafdb41-dc87-41ba-bba5-9afd99a08420/scratchpad/harness/packages/client/ui-theme/src/client/FontSizeRow.module.css.mjs
		const css = ".ZyLJfG_row{border-bottom:1px solid var(--dsw-alias-border-l2);align-items:center;gap:8px;padding:16px 0;display:flex}.ZyLJfG_rowText{flex-direction:column;flex:1;gap:4px;min-width:0;padding-right:48px;display:flex}.ZyLJfG_title{color:var(--dsw-alias-label-primary);font-size:14px;font-weight:400;line-height:22px}.ZyLJfG_desc{color:var(--dsw-alias-label-tertiary);font-size:12px;font-weight:400;line-height:18px}.ZyLJfG_control{align-items:center;gap:8px;display:inline-flex}.ZyLJfG_stepper{background:var(--dsw-alias-bg-module-platform);border-radius:18px;justify-content:center;align-items:center;min-width:72px;height:36px;display:inline-flex;position:relative}.ZyLJfG_value{text-align:center;font-variant-numeric:tabular-nums;min-width:18px;color:var(--dsw-alias-label-primary);font-size:14px;line-height:22px}.ZyLJfG_unit{color:var(--dsw-alias-label-secondary);font-size:14px;line-height:22px}.ZyLJfG_arrows{opacity:0;flex-direction:column;gap:2px;display:flex;position:absolute;right:8px}.ZyLJfG_stepper:hover .ZyLJfG_arrows,.ZyLJfG_stepper:focus-within .ZyLJfG_arrows{opacity:1}.ZyLJfG_arrow{background:color-mix(in srgb, var(--dsw-alias-bg-layer-1) 75%, transparent);width:17px;height:12px;color:var(--dsw-alias-label-primary);cursor:pointer;border:none;border-radius:3px;justify-content:center;align-items:center;padding:0;display:inline-flex}.ZyLJfG_arrow:hover:not(:disabled){background:var(--dsw-alias-bg-layer-1)}.ZyLJfG_arrow:disabled{color:var(--dsw-alias-label-caption);cursor:default}";
		...
		var FontSizeRow_module_css_default = {
			"arrow": "ZyLJfG_arrow",
			"arrows": "ZyLJfG_arrows",
			"control": "ZyLJfG_control",
			"desc": "ZyLJfG_desc",
			"row": "ZyLJfG_row",
			"rowText": "ZyLJfG_rowText",
			"stepper": "ZyLJfG_stepper",
			"title": "ZyLJfG_title",
			"unit": "ZyLJfG_unit",
			"value": "ZyLJfG_value"
		};
		...
		*/
		...
		//#endregion
		//#region \0dsh-inline-css:/private/tmp/claude-501/-Users-alex-Documents-Code-dataelem-dsh-desktop/8cafdb41-dc87-41ba-bba5-9afd99a08420/scratchpad/harness/packages/client/ui-theme/src/styles/base.css.mjs
		...
		//#endregion
		//#region \0dsh-inline-css:/private/tmp/claude-501/-Users-alex-Documents-Code-dataelem-dsh-desktop/8cafdb41-dc87-41ba-bba5-9afd99a08420/scratchpad/harness/packages/client/ui-theme/src/styles/design-platform.css.mjs
		...
		//#endregion
		//#region \0dsh-inline-css:/private/tmp/claude-501/-Users-alex-Documents-Code-dataelem-dsh-desktop/8cafdb41-dc87-41ba-bba5-9afd99a08420/scratchpad/harness/packages/client/ui-theme/src/styles/scrollbar.css.mjs
		...
		//#endregion
		//#region \0dsh-inline-css:/private/tmp/claude-501/-Users-alex-Documents-Code-dataelem-dsh-desktop/8cafdb41-dc87-41ba-bba5-9afd99a08420/scratchpad/harness/packages/client/ui-theme/src/styles/gradient-shadow-text.css.mjs
		...
		//#endregion
		//#region \0dsh-inline-css:/private/tmp/claude-501/-Users-alex-Documents-Code-dataelem-dsh-desktop/8cafdb41-dc87-41ba-bba5-9afd99a08420/scratchpad/harness/packages/client/ui-theme/src/styles/shiki.css.mjs
