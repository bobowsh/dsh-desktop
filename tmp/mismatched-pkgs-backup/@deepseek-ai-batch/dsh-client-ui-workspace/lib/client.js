window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:/private/tmp/claude-501/-Users-alex-Documents-Code-dataelem-dsh-desktop/8cafdb41-dc87-41ba-bba5-9afd99a08420/scratchpad/harness/packages/client/ui-workspace/src/client/rows/Rows.module.css.mjs
		const css$2 = ".koIWyW_projectRow,.koIWyW_sessionRow{cursor:pointer;user-select:none;color:var(--dsw-alias-label-primary);border-radius:8px;align-items:center;gap:6px;padding:0 8px;display:flex}.koIWyW_projectRow:hover,.koIWyW_sessionRow:hover,.koIWyW_sessionRow.koIWyW_selected{background:var(--dsw-alias-interactive-bg-hover)}.koIWyW_searchResultRow{box-sizing:border-box;cursor:pointer;text-align:left;width:100%;min-height:48px;color:var(--dsw-alias-label-primary);background:0 0;border:none;border-radius:8px;flex-direction:column;align-items:stretch;padding:4px 8px;display:flex}.koIWyW_searchResultRow:hover,.koIWyW_searchResultRow.koIWyW_selected{background:var(--dsw-alias-interactive-bg-hover)}.koIWyW_searchResultHeading{align-items:center;min-width:0;display:flex}.koIWyW_searchResultTitle{text-overflow:ellipsis;white-space:nowrap;min-width:0;margin-left:4px;font-size:14px;line-height:20px;overflow:hidden}.koIWyW_searchResultMeta{align-items:center;gap:6px;min-width:0;margin-left:20px;display:flex}.koIWyW_searchResultWorkspace,.koIWyW_searchResultSnippet{text-overflow:ellipsis;white-space:nowrap;font-size:12px;line-height:17px;overflow:hidden}.koIWyW_searchResultWorkspace{max-width:40%;color:var(--dsw-alias-label-tertiary);flex:none}.koIWyW_searchResultSnippet{min-width:0;color:var(--dsw-alias-label-secondary);flex:1}.koIWyW_projectRow{box-sizing:border-box;align-items:center;height:34px}.koIWyW_projectRow .koIWyW_rowActions{height:20px}.koIWyW_sessionRow{height:32px;animation:koIWyW_row-in .15s var(--ds-ease-in-out);gap:0}.koIWyW_sessionRow .koIWyW_title{margin:0 6px 0 4px}.koIWyW_flatSessionRowWithoutStatus .koIWyW_title{margin-left:0}@keyframes koIWyW_row-in{0%{opacity:0}}.koIWyW_slot{width:16px;height:20px;color:var(--dsw-alias-label-tertiary);flex:none;justify-content:center;align-items:center;display:inline-flex}.koIWyW_visuallyHidden{clip:rect(0 0 0 0);white-space:nowrap;width:1px;height:1px;position:absolute;overflow:hidden}.koIWyW_folderActive{color:var(--dsw-alias-state-business-primary)}.koIWyW_projectRow .koIWyW_chevron{display:none}.koIWyW_projectRow:hover .koIWyW_chevron{display:inline-flex}.koIWyW_projectRow:hover .koIWyW_folder{display:none}.koIWyW_arrow{transition:transform .15s var(--ds-ease-in-out)}.koIWyW_arrowOpen{transform:rotate(90deg)}.koIWyW_projectText{flex-direction:column;flex:1;gap:2px;min-width:0;display:flex}.koIWyW_title{text-overflow:ellipsis;white-space:nowrap;min-width:0;font-size:14px;line-height:20px;overflow:hidden}.koIWyW_renameInput{border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-button-elevated-fill);min-width:0;color:inherit;border-radius:4px;outline:none;padding:0 2px;font-size:14px;line-height:20px}.koIWyW_sessionRow .koIWyW_title{margin:0 6px 0 4px}.koIWyW_unreadTitle{font-weight:600}.koIWyW_unreadDot,.koIWyW_unreadMenuIcon{box-sizing:border-box;display:inline-block;border-radius:50%;background:var(--dsw-alias-state-business-primary)}.koIWyW_unreadDot{width:7px;height:7px}.koIWyW_unreadMenuIcon{width:9px;height:9px;border:2px solid var(--dsw-specific-menu);box-shadow:0 0 0 1px var(--dsw-alias-state-business-primary)}.koIWyW_meta{text-overflow:ellipsis;white-space:nowrap;color:var(--dsw-alias-label-tertiary);font-size:12px;line-height:20px;overflow:hidden}.koIWyW_time{color:var(--dsw-alias-label-tertiary);flex:none;font-size:12px;line-height:20px}.koIWyW_dot{flex:none}.koIWyW_rowActions{flex:none;align-items:center;gap:12px;display:none}.koIWyW_projectRow:hover .koIWyW_rowActions,.koIWyW_sessionRow:hover .koIWyW_rowActions,.koIWyW_projectRow.koIWyW_menuOpen .koIWyW_rowActions,.koIWyW_sessionRow.koIWyW_menuOpen .koIWyW_rowActions{display:inline-flex}.koIWyW_sessionRow:hover .koIWyW_time,.koIWyW_sessionRow.koIWyW_menuOpen .koIWyW_time{display:none}.koIWyW_projectRow.koIWyW_menuOpen,.koIWyW_sessionRow.koIWyW_menuOpen{background:var(--dsw-alias-interactive-bg-hover)}.koIWyW_sessionRow.koIWyW_dropBefore,.koIWyW_sessionRow.koIWyW_dropAfter{position:relative}.koIWyW_sessionRow.koIWyW_dropBefore:before,.koIWyW_sessionRow.koIWyW_dropAfter:after{content:\"\";z-index:1;background:linear-gradient(55deg, transparent calc(50% - 1px), var(--dsw-alias-state-business-primary) calc(50% - 1px) calc(50% + 1px), transparent calc(50% + 1px)) 0 0 / 5px 7px no-repeat, linear-gradient(125deg, transparent calc(50% - 1px), var(--dsw-alias-state-business-primary) calc(50% - 1px) calc(50% + 1px), transparent calc(50% + 1px)) 0 5px / 5px 7px no-repeat, linear-gradient(var(--dsw-alias-state-business-primary) 0 0) 4px 5px / calc(100% - 4px) 2px no-repeat;pointer-events:none;height:12px;position:absolute;left:0;right:4px}.koIWyW_sessionRow.koIWyW_dropBefore:before{top:-7px}.koIWyW_sessionRow.koIWyW_dropAfter:after{bottom:-7px}.koIWyW_hoverContent{flex-direction:column;gap:8px;display:flex}.koIWyW_hoverTitle{color:#fff;overflow-wrap:break-word;font-size:14px;line-height:20px}.koIWyW_hoverPath{color:#cfd3d6;word-break:break-all;font-size:12px;line-height:16px}.koIWyW_hoverTime{color:#cfd3d6;font-size:12px;line-height:16px}.koIWyW_hoverStatus{color:#adb2b8;align-items:center;gap:8px;font-size:12px;line-height:20px;display:flex}.koIWyW_iconButton{cursor:pointer;width:16px;height:16px;color:var(--dsw-alias-label-tertiary);background:0 0;border:none;border-radius:4px;flex:none;justify-content:center;align-items:center;padding:0;display:inline-flex}.koIWyW_iconButton:hover{color:var(--dsw-alias-label-primary)}.koIWyW_chevron{color:var(--dsw-alias-label-caption)}@media (prefers-reduced-motion:reduce){.koIWyW_sessionRow,.koIWyW_arrow{transition:none;animation:none}}";
		...
		var Rows_module_css_default = {
			"arrow": "koIWyW_arrow",
			"arrowOpen": "koIWyW_arrowOpen",
			"chevron": "koIWyW_chevron",
			"dot": "koIWyW_dot",
			"dropAfter": "koIWyW_dropAfter",
			"dropBefore": "koIWyW_dropBefore",
			"flatSessionRowWithoutStatus": "koIWyW_flatSessionRowWithoutStatus",
			"folder": "koIWyW_folder",
			"folderActive": "koIWyW_folderActive",
			"hoverContent": "koIWyW_hoverContent",
			"hoverPath": "koIWyW_hoverPath",
			"hoverStatus": "koIWyW_hoverStatus",
			"hoverTime": "koIWyW_hoverTime",
			"hoverTitle": "koIWyW_hoverTitle",
			"iconButton": "koIWyW_iconButton",
			"menuOpen": "koIWyW_menuOpen",
			"meta": "koIWyW_meta",
			"projectRow": "koIWyW_projectRow",
			"projectText": "koIWyW_projectText",
			"renameInput": "koIWyW_renameInput",
			"unreadDot": "koIWyW_unreadDot",
			"unreadMenuIcon": "koIWyW_unreadMenuIcon",
			"unreadTitle": "koIWyW_unreadTitle",
			"row-in": "koIWyW_row-in",
			"rowActions": "koIWyW_rowActions",
			"searchResultHeading": "koIWyW_searchResultHeading",
			"searchResultMeta": "koIWyW_searchResultMeta",
			"searchResultRow": "koIWyW_searchResultRow",
			"searchResultSnippet": "koIWyW_searchResultSnippet",
			"searchResultTitle": "koIWyW_searchResultTitle",
			"searchResultWorkspace": "koIWyW_searchResultWorkspace",
			"selected": "koIWyW_selected",
			"sessionRow": "koIWyW_sessionRow",
			"slot": "koIWyW_slot",
			"time": "koIWyW_time",
			"title": "koIWyW_title",
			"visuallyHidden": "koIWyW_visuallyHidden"
		};
		//#endregion
		...
		*/
		function SessionNodeItem({ node, currentId, now, onOpen, onRename, onFork, onArchive, unread, onUnreadChange, drag, flat = false, t }) {
			const row = node;
		...
		//#endregion
		//#region \0dsh-css:/private/tmp/claude-501/-Users-alex-Documents-Code-dataelem-dsh-desktop/8cafdb41-dc87-41ba-bba5-9afd99a08420/scratchpad/harness/packages/client/ui-workspace/src/client/WorkspacePicker.module.css.mjs
		const css$1 = "._3ow9CG_modalAction{min-width:72px}._3ow9CG_modalError,._3ow9CG_menuStatus{margin-top:8px;font-size:12px;line-height:18px}._3ow9CG_modalError{color:var(--dsw-alias-state-error-primary)}._3ow9CG_menuStatus{color:var(--dsw-alias-label-secondary)}";
		...
		var WorkspacePicker_module_css_default = {
			"menuStatus": "_3ow9CG_menuStatus",
			"modalAction": "_3ow9CG_modalAction",
			"modalError": "_3ow9CG_modalError"
		};
		//#endregion
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:/private/tmp/claude-501/-Users-alex-Documents-Code-dataelem-dsh-desktop/8cafdb41-dc87-41ba-bba5-9afd99a08420/scratchpad/harness/packages/client/ui-workspace/src/client/rows/WorkspaceBrowser.module.css.mjs
		const css = ".cAve2a_root{--dsh-session-list-edge-inset:var(--dsh-sidebar-inline-padding);--dsh-session-list-scrollbar-width:8px;--dsh-session-list-scrollbar-offset:2px;box-sizing:border-box;min-height:0;padding-right:var(--dsh-session-list-edge-inset);flex-direction:column;flex:1;display:flex}.cAve2a_root.cAve2a_rail{padding-right:0}.cAve2a_iconButton{cursor:pointer;width:28px;height:28px;color:var(--dsw-alias-label-secondary);background:0 0;border:none;border-radius:50%;flex:none;justify-content:center;align-items:center;padding:0;display:inline-flex}.cAve2a_iconButton:hover{background:var(--dsw-alias-interactive-bg-hover)}.cAve2a_sectionHeader{box-sizing:border-box;height:36px;color:var(--dsw-alias-label-tertiary);border-radius:12px;flex:none;justify-content:flex-end;align-items:center;gap:4px;margin-bottom:4px;padding-left:4px;display:flex;overflow:hidden}.cAve2a_root:not(.cAve2a_rail) .cAve2a_sectionHeader{margin-top:2px;margin-right:-4px}.cAve2a_sectionLabel{white-space:nowrap;opacity:1;visibility:visible;min-width:0;max-width:45%;transition:max-width .18s var(--ds-ease-in-out), margin-right .18s var(--ds-ease-in-out), opacity .12s var(--ds-ease-in-out), transform .18s var(--ds-ease-in-out), visibility 0s linear;flex:none;line-height:20px;overflow:hidden}.cAve2a_sectionLabelHidden{opacity:0;visibility:hidden;max-width:0;margin-right:-4px;transition-delay:0s,0s,0s,0s,.18s;transform:translate(-4px)}.cAve2a_searchSlot{box-sizing:border-box;min-width:0;max-width:28px;transition:max-width .18s var(--ds-ease-in-out), padding-left .18s var(--ds-ease-in-out);flex:1;align-items:center;margin-left:auto;padding-left:0;display:flex}.cAve2a_searchSlotExpanded{max-width:100%;padding-left:0}.cAve2a_headerActions{opacity:1;visibility:visible;max-width:60px;transition:max-width .18s var(--ds-ease-in-out), opacity .12s var(--ds-ease-in-out), transform .18s var(--ds-ease-in-out), visibility 0s linear;flex:none;align-items:center;gap:4px;display:flex;overflow:hidden}.cAve2a_headerActionsHidden{opacity:0;visibility:hidden;pointer-events:none;max-width:0;transition-delay:0s,0s,0s,.18s;transform:translate(4px)}.cAve2a_search{box-sizing:border-box;cursor:text;width:100%;height:28px;color:var(--dsw-alias-label-secondary);transition:width .18s var(--ds-ease-in-out), padding .18s var(--ds-ease-in-out), border-color .18s var(--ds-ease-in-out), background-color .18s var(--ds-ease-in-out);background:0 0;border:none;border-radius:50%;flex:none;align-items:center;gap:0;margin:0;padding:0;display:flex;overflow:hidden}.cAve2a_searchExpanded{border:1px solid var(--dsw-alias-border-l2);width:calc(100% + 4px);height:30px;color:var(--dsw-alias-label-caption);background:0 0;border-radius:10px;margin-inline:-2px;padding:0 4px 0 0}.cAve2a_searchButton{cursor:pointer;width:28px;height:28px;color:inherit;background:0 0;border:none;border-radius:50%;flex:none;justify-content:center;align-items:center;padding:0;display:inline-flex}.cAve2a_searchExpanded .cAve2a_searchButton{width:28px;height:30px}.cAve2a_searchButton:hover{background:var(--dsw-alias-interactive-bg-hover)}.cAve2a_searchExpanded .cAve2a_searchButton:hover{background:0 0}.cAve2a_searchInput{opacity:0;pointer-events:none;width:0;min-width:0;color:var(--dsw-alias-label-primary);transition:opacity .12s var(--ds-ease-in-out);background:0 0;border:none;outline:none;flex:1;font-size:13px;line-height:18px}.cAve2a_searchExpanded .cAve2a_searchInput{opacity:1;pointer-events:auto;margin-left:-2px}.cAve2a_searchInput::placeholder{color:var(--dsw-alias-label-tertiary)}.cAve2a_clearButton{cursor:pointer;width:24px;height:24px;color:var(--dsw-alias-label-secondary);background:0 0;border:none;border-radius:50%;flex:none;justify-content:center;align-items:center;padding:0;display:inline-flex}.cAve2a_clearButton:hover{background:var(--dsw-alias-interactive-bg-hover)}.cAve2a_rail .cAve2a_sectionHeader{justify-content:flex-start;gap:0;margin-bottom:12px;padding-left:0}.cAve2a_rail .cAve2a_headerActions{max-width:none}.cAve2a_rail .cAve2a_iconButton{width:36px;height:36px;color:var(--dsw-alias-label-primary)}.cAve2a_rail .cAve2a_search{background:0 0;border-color:#0000;gap:0;width:36px;height:36px;margin:0 0 12px;padding:0}.cAve2a_rail .cAve2a_searchButton{width:36px;height:36px;color:var(--dsw-alias-label-primary)}.cAve2a_rail .cAve2a_searchButton:hover{background:var(--dsw-alias-interactive-bg-hover)}.cAve2a_listArea{min-height:0;margin-left:-4px;margin-right:calc(-1 * var(--dsh-session-list-edge-inset));flex-direction:column;flex:1;padding-left:4px;display:flex;overflow:visible}.cAve2a_rail .cAve2a_listArea{margin-left:0;margin-right:0;padding-left:0}.cAve2a_treeBody{flex-direction:column;flex:1;min-height:0;display:flex;position:relative}.cAve2a_fade{left:0;right:var(--dsh-session-list-edge-inset);background:linear-gradient(to bottom, transparent, var(--dsw-specific-sidebar-fill));pointer-events:none;height:24px;position:absolute;bottom:0}.cAve2a_wide{animation:cAve2a_wide-in .2s var(--ds-ease-in-out)}@keyframes cAve2a_wide-in{0%{opacity:0}}.cAve2a_list{min-height:0;margin-left:-4px;margin-right:var(--dsh-session-list-scrollbar-offset);padding-left:4px;padding-right:calc(var(--dsh-session-list-edge-inset) - var(--dsh-session-list-scrollbar-width) - var(--dsh-session-list-scrollbar-offset));scrollbar-gutter:stable;flex:1;padding-bottom:16px;overflow-y:auto}.cAve2a_flatList>*+*,.cAve2a_searchTree>[role=treeitem]+[role=treeitem],.cAve2a_groupSection>*+*{margin-top:2px}.cAve2a_searchStatus,.cAve2a_searchWarning{color:var(--dsw-alias-label-tertiary);padding:10px 12px;font-size:12px;line-height:18px}.cAve2a_searchWarning{color:var(--dsw-alias-label-secondary)}.cAve2a_groupSection{position:relative}.cAve2a_groupSection+.cAve2a_groupSection{margin-top:4px}.cAve2a_listTopDropIndicator,.cAve2a_workspaceDropBefore:before,.cAve2a_workspaceDropAfter:after{content:\"\";z-index:1;background:linear-gradient(55deg, transparent calc(50% - 1px), var(--dsw-alias-state-business-primary) calc(50% - 1px) calc(50% + 1px), transparent calc(50% + 1px)) 0 0 / 5px 7px no-repeat, linear-gradient(125deg, transparent calc(50% - 1px), var(--dsw-alias-state-business-primary) calc(50% - 1px) calc(50% + 1px), transparent calc(50% + 1px)) 0 5px / 5px 7px no-repeat, linear-gradient(var(--dsw-alias-state-business-primary) 0 0) 4px 5px / calc(100% - 4px) 2px no-repeat;pointer-events:none;height:12px;position:absolute;left:0;right:0}.cAve2a_listTopDropIndicator{top:-8px;left:0;right:var(--dsh-session-list-edge-inset)}.cAve2a_listTopDropActive>.cAve2a_workspaceDropBefore:first-child:before{display:none}.cAve2a_workspaceDropBefore:before{top:-8px}.cAve2a_workspaceDropAfter:after{bottom:-8px}.cAve2a_sessionOverflowButton{cursor:pointer;text-align:left;width:100%;height:28px;color:var(--dsw-alias-label-tertiary);background:0 0;border:none;border-radius:8px;padding:0 12px 0 28px;font-size:12px}.cAve2a_groupSection>.cAve2a_sessionOverflowButton{margin-top:0}.cAve2a_sessionOverflowButton:hover{color:var(--dsw-alias-label-secondary);background:0 0}.cAve2a_empty{color:var(--dsw-alias-label-tertiary);padding:16px 12px;font-size:13px}.cAve2a_renameInput{box-sizing:border-box;border:1px solid var(--dsw-alias-border-l2);width:100%;height:44px;color:var(--dsw-alias-label-primary);background:0 0;border-radius:22px;outline:none;padding:7px 14px;font-size:14px;font-weight:400;line-height:22px}.cAve2a_renameInput:disabled{color:var(--dsw-alias-label-dimmed)}.cAve2a_renameError{color:var(--dsw-alias-state-error-primary);margin-top:8px;font-size:12px;line-height:18px}.cAve2a_deleteAction:not(:disabled){color:var(--dsw-alias-state-error-primary)}.cAve2a_deleteStatus{color:var(--dsw-alias-label-secondary);font-size:12px;line-height:18px}@media (prefers-reduced-motion:reduce){.cAve2a_wide{animation:none}.cAve2a_search,.cAve2a_sectionLabel,.cAve2a_searchSlot,.cAve2a_searchInput,.cAve2a_headerActions{transition:none}}";
		...
		var WorkspaceBrowser_module_css_default = {
			"clearButton": "cAve2a_clearButton",
			"deleteAction": "cAve2a_deleteAction",
			"deleteStatus": "cAve2a_deleteStatus",
			"empty": "cAve2a_empty",
			"fade": "cAve2a_fade",
			"flatList": "cAve2a_flatList",
			"groupSection": "cAve2a_groupSection",
			"headerActions": "cAve2a_headerActions",
			"headerActionsHidden": "cAve2a_headerActionsHidden",
			"iconButton": "cAve2a_iconButton",
			"list": "cAve2a_list",
			"listArea": "cAve2a_listArea",
			"listTopDropActive": "cAve2a_listTopDropActive",
			"listTopDropIndicator": "cAve2a_listTopDropIndicator",
			"rail": "cAve2a_rail",
			"renameError": "cAve2a_renameError",
			"renameInput": "cAve2a_renameInput",
			"root": "cAve2a_root",
			"search": "cAve2a_search",
			"searchButton": "cAve2a_searchButton",
			"searchExpanded": "cAve2a_searchExpanded",
			"searchInput": "cAve2a_searchInput",
			"searchSlot": "cAve2a_searchSlot",
			"searchSlotExpanded": "cAve2a_searchSlotExpanded",
			"searchStatus": "cAve2a_searchStatus",
			"searchTree": "cAve2a_searchTree",
			"searchWarning": "cAve2a_searchWarning",
			"sectionHeader": "cAve2a_sectionHeader",
			"sectionLabel": "cAve2a_sectionLabel",
			"sectionLabelHidden": "cAve2a_sectionLabelHidden",
			"sessionOverflowButton": "cAve2a_sessionOverflowButton",
			"treeBody": "cAve2a_treeBody",
			"wide": "cAve2a_wide",
			"wide-in": "cAve2a_wide-in",
			"workspaceDropAfter": "cAve2a_workspaceDropAfter",
			"workspaceDropBefore": "cAve2a_workspaceDropBefore"
		};
		//#endregion
		...
		*/
		...
		function FlatList({ useSessions, useSessionPendingInteraction, open, forkSession, onSessionRename, onSessionArchive, archivedSessionIds, unreadSessionIds, onUnreadChange, orderBy, sessionOrderByAccount, sessionUpdatedAtByAccount, syncSessionOrderAccount, setSessionOrder, t }) {
			const list = useSessions((s) => s);
			const pendingInteractions = useSessionPendingInteraction((s) => s);
