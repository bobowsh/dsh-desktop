window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		//#endregion
		//#region \0dsh-css:/private/tmp/claude-501/-Users-alex-Documents-Code-dataelem-dsh-desktop/8cafdb41-dc87-41ba-bba5-9afd99a08420/scratchpad/harness/packages/client/ui-directory-picker-browse/src/client/DirectoryBrowser.module.css.mjs
		const css = ".JIKUNG_dialog.JIKUNG_dialog{--dsh-scrollbar-thumb:var(--dsw-alias-scrollbar-bg-l2);--dsh-scrollbar-thumb-hover:var(--dsw-alias-scrollbar-hover-l2);gap:0;width:min(680px,100%);height:min(500px,100dvh - 32px);padding:0}.JIKUNG_editorScope{display:contents}.JIKUNG_header{border-bottom:1px solid var(--dsw-alias-border-l3);flex-direction:column;flex:none;gap:8px;padding:16px 14px 8px 24px;display:flex}.JIKUNG_title{min-height:28px;color:var(--dsw-alias-label-primary);align-items:flex-end;margin:0;font-size:16px;font-weight:510;line-height:24px;display:flex}.JIKUNG_crumbBar{box-sizing:border-box;border:1px solid #0000;border-radius:8px;align-items:center;gap:4px;min-height:24px;margin-left:-9px;padding:0 8px;display:flex}.JIKUNG_crumbBar:has(.JIKUNG_crumbEditZone:enabled:hover),.JIKUNG_crumbBar:has(.JIKUNG_crumbEditZone:focus-visible),.JIKUNG_crumbBar:has(.JIKUNG_pathInput){border-color:var(--dsw-alias-border-l2)}.JIKUNG_millerRow{scrollbar-width:none;flex:1 1 0;align-items:stretch;gap:12px;min-height:0;display:flex;overflow-x:auto}.JIKUNG_crumbTrail{scrollbar-width:none;flex:0 auto;align-items:center;gap:4px;min-width:0;display:flex;overflow-x:auto}.JIKUNG_crumbSeat{flex:none;align-items:center;gap:4px;min-width:0;display:inline-flex}.JIKUNG_crumb{text-overflow:ellipsis;white-space:nowrap;max-width:160px;color:var(--dsw-alias-label-tertiary);cursor:pointer;background:0 0;border:none;padding:0;font-size:13px;font-weight:500;line-height:20px;overflow:hidden}.JIKUNG_crumb:hover{color:var(--dsw-alias-label-primary)}.JIKUNG_crumbChevron{color:var(--dsw-alias-label-tertiary);flex:none}.JIKUNG_crumbEditZone{cursor:text;background:0 0;border:none;outline:none;flex:1 0 34px;justify-content:flex-end;align-items:center;min-width:34px;height:22px;padding:0;display:flex}.JIKUNG_crumbEditGlyph{color:var(--dsw-alias-label-tertiary);flex:none}.JIKUNG_crumbEditZone:enabled:hover .JIKUNG_crumbEditGlyph,.JIKUNG_crumbEditZone:focus-visible .JIKUNG_crumbEditGlyph{color:var(--dsw-alias-label-primary)}.JIKUNG_crumbEditZone:disabled{cursor:default}.JIKUNG_crumbEditZone:disabled .JIKUNG_crumbEditGlyph{color:var(--dsw-alias-label-caption)}.JIKUNG_pathInput{box-sizing:border-box;min-width:0;height:22px;color:var(--dsw-alias-label-primary);background:0 0;border:none;outline:none;flex:1 1 0;padding:0;font-size:13px;line-height:20px}.JIKUNG_content{flex-direction:column;flex:1 1 0;min-height:0;padding:16px 16px 16px 24px;display:flex;position:relative}.JIKUNG_column{flex-direction:column;flex:1 1 0;gap:2px;min-width:256px;padding-right:8px;display:flex;overflow-y:auto}.JIKUNG_divider{background:var(--dsw-alias-border-l3);flex:none;width:1px}.JIKUNG_rowSeat{flex:none;display:flex}.JIKUNG_row{text-align:left;cursor:pointer;background:0 0;border:none;border-radius:6px;flex:none;align-items:center;gap:4px;width:100%;height:28px;padding:4px;display:flex}.JIKUNG_row:hover{background:var(--dsw-alias-interactive-bg-hover)}.JIKUNG_rowSelected,.JIKUNG_rowSelected:hover{background:var(--dsw-alias-interactive-bg-active,var(--dsw-alias-interactive-bg-hover))}.JIKUNG_rowIcon{color:var(--dsw-alias-label-secondary);flex:none}.JIKUNG_rowIconSelected{color:var(--dsw-alias-button-info-fill);flex:none}.JIKUNG_rowName{text-overflow:ellipsis;white-space:nowrap;min-width:0;color:var(--dsw-alias-label-primary);flex:1 1 0;font-size:13px;font-weight:500;line-height:20px;overflow:hidden}.JIKUNG_rowChevron{color:var(--dsw-alias-label-tertiary);flex:none}.JIKUNG_status,.JIKUNG_error{padding:4px 120px 4px 4px;font-size:12px;line-height:18px}.JIKUNG_status{color:var(--dsw-alias-label-secondary)}.JIKUNG_error{color:var(--dsw-alias-state-error-primary)}.JIKUNG_loadingFloat{background:var(--dsw-alias-bg-layer-2);padding:2px 8px;position:absolute;bottom:8px;right:16px}.JIKUNG_footerBar{border-top:1px solid var(--dsw-alias-border-l3);flex-wrap:wrap;flex:none;align-items:center;gap:8px;padding:16px 24px;display:flex}.JIKUNG_showHiddenToggle{color:var(--dsw-alias-label-secondary);cursor:pointer;white-space:nowrap;background:0 0;border:none;align-items:center;gap:4px;padding:0;font-size:13px;font-weight:500;line-height:20px;display:inline-flex}.JIKUNG_showHiddenToggle:hover{color:var(--dsw-alias-label-primary)}.JIKUNG_showHiddenToggle:disabled{color:var(--dsw-alias-label-caption);cursor:default}.JIKUNG_showHiddenToggleActive{color:var(--dsw-alias-label-primary)}.JIKUNG_footerGap{flex:1 1 0}.JIKUNG_footerAction{min-width:72px}.JIKUNG_createDialog.JIKUNG_createDialog{gap:0;width:min(380px,100%);padding:0}.JIKUNG_createBody{flex-direction:column;gap:12px;padding:22px 24px 20px;display:flex}.JIKUNG_createTitle{color:var(--dsw-alias-label-primary);margin:0;font-size:16px;font-weight:510;line-height:24px}.JIKUNG_createIn{color:var(--dsw-alias-label-primary);margin:0;font-size:14px;line-height:22px}.JIKUNG_createInput{box-sizing:border-box;border:1px solid var(--dsw-alias-border-l2);width:100%;height:44px;color:var(--dsw-alias-label-primary);background:0 0;border-radius:22px;outline:none;padding:7px 14px;font-size:14px;line-height:22px}.JIKUNG_createInput::placeholder{color:var(--dsw-alias-label-caption)}.JIKUNG_createActions{justify-content:flex-end;align-items:center;gap:8px;margin-top:8px;display:flex}";
		...
		var DirectoryBrowser_module_css_default = {
			"column": "JIKUNG_column",
			"content": "JIKUNG_content",
			"createActions": "JIKUNG_createActions",
			"createBody": "JIKUNG_createBody",
			"createDialog": "JIKUNG_createDialog",
			"createIn": "JIKUNG_createIn",
			"createInput": "JIKUNG_createInput",
			"createTitle": "JIKUNG_createTitle",
			"crumb": "JIKUNG_crumb",
			"crumbBar": "JIKUNG_crumbBar",
			"crumbChevron": "JIKUNG_crumbChevron",
			"crumbEditGlyph": "JIKUNG_crumbEditGlyph",
			"crumbEditZone": "JIKUNG_crumbEditZone",
			"crumbSeat": "JIKUNG_crumbSeat",
			"crumbTrail": "JIKUNG_crumbTrail",
			"dialog": "JIKUNG_dialog",
			"divider": "JIKUNG_divider",
			"editorScope": "JIKUNG_editorScope",
			"error": "JIKUNG_error",
			"footerAction": "JIKUNG_footerAction",
			"footerBar": "JIKUNG_footerBar",
			"footerGap": "JIKUNG_footerGap",
			"header": "JIKUNG_header",
			"loadingFloat": "JIKUNG_loadingFloat",
			"millerRow": "JIKUNG_millerRow",
			"pathInput": "JIKUNG_pathInput",
			"row": "JIKUNG_row",
			"rowChevron": "JIKUNG_rowChevron",
			"rowIcon": "JIKUNG_rowIcon",
			"rowIconSelected": "JIKUNG_rowIconSelected",
			"rowName": "JIKUNG_rowName",
			"rowSeat": "JIKUNG_rowSeat",
			"rowSelected": "JIKUNG_rowSelected",
			"showHiddenToggle": "JIKUNG_showHiddenToggle",
			"showHiddenToggleActive": "JIKUNG_showHiddenToggleActive",
			"status": "JIKUNG_status",
			"title": "JIKUNG_title"
		};
		//#endregion
