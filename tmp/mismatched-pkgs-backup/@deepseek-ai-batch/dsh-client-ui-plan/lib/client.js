window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		//#region \0dsh-css:/private/tmp/claude-501/-Users-alex-Documents-Code-dataelem-dsh-desktop/8cafdb41-dc87-41ba-bba5-9afd99a08420/scratchpad/harness/packages/client/ui-plan/src/client/PlanModeControl.module.css.mjs
		const css = ".hY1T4q_wrap{align-items:center;gap:6px;display:inline-flex}.hY1T4q_chip{background:var(--dsw-alias-state-warn-tertiary);min-width:34px;color:var(--dsw-alias-state-warn-label);cursor:pointer;border:none;border-radius:999px;align-items:center;gap:4px;padding:2px 8px;font-size:13px;font-weight:500;line-height:20px;display:inline-flex}.hY1T4q_chip:hover:not(:disabled){color:var(--dsw-alias-state-warn-primary)}.hY1T4q_chip:focus-visible{outline:2px solid var(--dsw-alias-state-warn-label);outline-offset:2px}.hY1T4q_chip:disabled{opacity:.6;cursor:default}.hY1T4q_close{color:currentColor;align-items:center;display:inline-flex}.hY1T4q_error{color:var(--dsw-alias-state-error-primary);font-size:12px;line-height:18px}";
