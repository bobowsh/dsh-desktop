window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:/private/tmp/claude-501/-Users-alex-Documents-Code-dataelem-dsh-desktop/8cafdb41-dc87-41ba-bba5-9afd99a08420/scratchpad/harness/packages/client/ui-input-trigger/src/client/MenuView.module.css.mjs
		const css = ".pTrt9W_menu{z-index:100;--dsh-scrollbar-thumb:var(--dsw-alias-scrollbar-bg-l2);--dsh-scrollbar-thumb-hover:var(--dsw-alias-scrollbar-hover-l2);border:1px solid var(--dsw-alias-border-inverted);background:var(--dsw-specific-menu);max-height:320px;box-shadow:var(--dsw-shadow-lv3);border-radius:12px;flex-direction:column;padding:4px;display:flex;position:absolute;bottom:calc(100% + 4px);left:0;right:0;overflow:hidden}.pTrt9W_viewport{flex-direction:column;min-height:0;display:flex;overflow-y:auto}.pTrt9W_item{cursor:pointer;width:100%;min-height:40px;color:var(--dsw-alias-label-primary);text-align:left;background:0 0;border:none;border-radius:10px;align-items:center;gap:8px;padding:8px 10px;font-size:14px;line-height:22px;display:flex}.pTrt9W_item.pTrt9W_active{background:var(--dsw-alias-interactive-bg-hover)}.pTrt9W_sectionTitle{min-height:26px;color:var(--dsw-alias-label-tertiary);flex:none;padding:6px 10px 2px;font-size:12px;font-weight:500;line-height:18px}.pTrt9W_sectionTitle:not(:first-child){margin-top:4px}.pTrt9W_itemIcon{width:16px;height:16px;color:var(--dsw-alias-label-tertiary);flex:none;justify-content:center;align-items:center;display:inline-flex}.pTrt9W_itemName{text-overflow:ellipsis;white-space:nowrap;flex:none;max-width:40%;overflow:hidden}.pTrt9W_itemDescription{text-overflow:ellipsis;white-space:nowrap;min-width:0;color:var(--dsw-alias-label-tertiary);flex:1;overflow:hidden}.pTrt9W_trailing{flex:none;align-items:center;gap:4px;margin-left:auto;display:inline-flex}.pTrt9W_drillHintText{color:var(--dsw-alias-label-caption);white-space:nowrap;font-size:11px;line-height:18px;display:none}.pTrt9W_drillHint{background:var(--dsw-alias-interactive-bg-hover);color:var(--dsw-alias-label-caption);border-radius:4px;padding:0 5px;font-family:inherit;font-size:11px;line-height:18px;display:none}.pTrt9W_item.pTrt9W_active .pTrt9W_drillHintText,.pTrt9W_item.pTrt9W_active .pTrt9W_drillHint{display:inline-flex}.pTrt9W_drill{width:20px;height:20px;color:var(--dsw-alias-label-caption);border-radius:4px;flex:none;place-items:center;display:inline-grid}.pTrt9W_drill:hover{background:var(--dsw-alias-interactive-bg-hover);color:var(--dsw-alias-label-primary)}.pTrt9W_groupTitle{color:var(--dsw-alias-label-tertiary);padding:8px 10px;font-size:12px;line-height:16px}.pTrt9W_skeletonRow{box-sizing:border-box;align-items:center;min-height:40px;padding:8px 10px;display:flex}.pTrt9W_skeletonBar{background:var(--dsw-alias-bg-skeleton);border-radius:4px;height:20px;animation:2s cubic-bezier(.36,0,.64,1) infinite pTrt9W_dsh-menu-skeleton}@keyframes pTrt9W_dsh-menu-skeleton{0%{opacity:1}40%{opacity:.6}80%,to{opacity:1}}.pTrt9W_crumbs{border-bottom:1px solid var(--dsw-alias-border-inverted);flex-wrap:wrap;flex:none;align-items:center;gap:2px;margin-bottom:2px;padding:4px 6px 6px;display:flex}.pTrt9W_crumb{max-width:40%;color:var(--dsw-alias-label-tertiary);cursor:pointer;text-overflow:ellipsis;white-space:nowrap;background:0 0;border:none;border-radius:6px;flex:0 auto;padding:2px 6px;font-family:inherit;font-size:12px;line-height:18px;overflow:hidden}.pTrt9W_crumb:hover{background:var(--dsw-alias-interactive-bg-hover);color:var(--dsw-alias-label-primary)}.pTrt9W_crumbCurrent,.pTrt9W_crumbCurrent:hover{color:var(--dsw-alias-label-primary);cursor:default;background:0 0}.pTrt9W_crumbSeparator{color:var(--dsw-alias-label-caption);flex:none;display:inline-flex}";
		...
		var MenuView_module_css_default = {
			"active": "pTrt9W_active",
			"crumb": "pTrt9W_crumb",
			"crumbCurrent": "pTrt9W_crumbCurrent",
			"crumbSeparator": "pTrt9W_crumbSeparator",
			"crumbs": "pTrt9W_crumbs",
			"drill": "pTrt9W_drill",
			"drillHint": "pTrt9W_drillHint",
			"drillHintText": "pTrt9W_drillHintText",
			"dsh-menu-skeleton": "pTrt9W_dsh-menu-skeleton",
			"groupTitle": "pTrt9W_groupTitle",
			"item": "pTrt9W_item",
			"itemDescription": "pTrt9W_itemDescription",
			"itemIcon": "pTrt9W_itemIcon",
			"itemName": "pTrt9W_itemName",
			"menu": "pTrt9W_menu",
			"sectionTitle": "pTrt9W_sectionTitle",
			"skeletonBar": "pTrt9W_skeletonBar",
			"skeletonRow": "pTrt9W_skeletonRow",
			"trailing": "pTrt9W_trailing",
			"viewport": "pTrt9W_viewport"
		};
		//#endregion
