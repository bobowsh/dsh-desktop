window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:/private/tmp/claude-501/-Users-alex-Documents-Code-dataelem-dsh-desktop/8cafdb41-dc87-41ba-bba5-9afd99a08420/scratchpad/harness/packages/client/ui-chat/src/client/chat/MessageItem.module.css.mjs
		const css$15 = ".uSmzmW_userRow{flex-direction:column;align-items:flex-end;gap:6px;display:flex}.uSmzmW_userStack{min-width:0;max-width:min(calc(var(--dsh-chat-content-width,748px) * .702), 82%);flex-direction:column;align-items:flex-end;gap:8px;display:flex}.uSmzmW_bubble{background:var(--dsw-specific-bubble);max-width:100%;font-size:var(--dsh-content-font-size,14px);line-height:calc(22px + var(--dsh-content-font-delta,0px));color:var(--dsw-alias-label-primary);white-space:pre-wrap;word-break:break-word;border-radius:22px;padding:10px 16px}.uSmzmW_referenceSummary{color:var(--dsw-alias-label-tertiary);font-size:var(--dsh-content-font-size-secondary,13px);line-height:calc(18px + var(--dsh-content-font-delta-secondary,0px))}.uSmzmW_contextRow,.uSmzmW_compactionRow{padding:2px 0}.uSmzmW_compactionButton{width:100%;height:calc(24px + var(--dsh-content-font-delta,0px));min-width:0;color:inherit;font:inherit;text-align:left;background:0 0;border:none;border-radius:6px;align-items:center;padding:0;display:flex}.uSmzmW_compactionButton:not(:disabled){cursor:pointer}.uSmzmW_compactionButton:not(:disabled):hover{background:var(--dsw-alias-interactive-bg-hover)}.uSmzmW_compactionLeading{width:calc(16px + var(--dsh-content-font-delta,0px));height:calc(16px + var(--dsh-content-font-delta,0px));color:var(--dsw-alias-label-secondary);flex:none;place-items:center;margin-right:6px;display:inline-grid}.uSmzmW_compactionLeading svg{width:calc(14px + var(--dsh-content-font-delta,0px));height:calc(14px + var(--dsh-content-font-delta,0px))}.uSmzmW_compactionContextIcon,.uSmzmW_compactionDisclosureIcon{grid-area:1/1;justify-content:center;align-items:center;display:inline-flex}.uSmzmW_compactionDisclosureIcon,.uSmzmW_compactionButton:not(:disabled):hover .uSmzmW_compactionContextIcon,.uSmzmW_compactionButton:not(:disabled):focus-visible .uSmzmW_compactionContextIcon{opacity:0}.uSmzmW_compactionButton:not(:disabled):hover .uSmzmW_compactionDisclosureIcon,.uSmzmW_compactionButton:not(:disabled):focus-visible .uSmzmW_compactionDisclosureIcon{opacity:1}.uSmzmW_compactionTitle{font-size:var(--dsh-content-font-size-secondary,13px);line-height:calc(24px + var(--dsh-content-font-delta,0px));color:var(--dsw-alias-label-primary-dimmed);flex:none}.uSmzmW_compactionSep{background:var(--dsw-alias-label-caption);border-radius:1px;flex:none;width:2px;height:2px;margin:0 8px}.uSmzmW_compactionSummary{min-width:0;color:var(--dsw-alias-label-tertiary);font-size:var(--dsh-content-font-size-secondary,13px);line-height:calc(24px + var(--dsh-content-font-delta,0px));text-overflow:ellipsis;white-space:nowrap;flex:auto;overflow:hidden}.uSmzmW_compactionBody{padding:4px 0 4px calc(22px + var(--dsh-content-font-delta,0px));color:var(--dsw-alias-label-tertiary);font-size:var(--dsh-content-font-size-secondary,13px);line-height:calc(24px + var(--dsh-content-font-delta,0px))}.uSmzmW_retryRow{color:var(--dsw-alias-label-tertiary);font-size:var(--dsh-content-font-size-secondary,13px);line-height:calc(20px + var(--dsh-content-font-delta-secondary,0px))}.uSmzmW_retrySummary{width:fit-content;color:inherit;cursor:pointer;user-select:none;border-radius:3px;align-items:center;gap:7px;padding:2px 0;list-style:none;display:inline-flex}.uSmzmW_retrySummary::-webkit-details-marker{display:none}.uSmzmW_retrySummary:after{content:\"\";opacity:.8;border-bottom:1.5px solid;border-right:1.5px solid;width:6px;height:6px;transition:transform .12s;transform:rotate(-45deg)}.uSmzmW_retrySummary:hover{color:var(--dsw-alias-label-secondary)}.uSmzmW_retrySummary:focus-visible{outline:1.5px solid var(--dsw-alias-button-info-fill);outline-offset:2px}.uSmzmW_retryText{color:inherit}.uSmzmW_retryRow[data-active] .uSmzmW_retryText{background:linear-gradient(90deg, var(--dsw-alias-label-tertiary) 0%, var(--dsw-alias-label-tertiary) 40%, var(--dsw-alias-label-secondary) 50%, var(--dsw-alias-label-tertiary) 60%, var(--dsw-alias-label-tertiary) 100%);color:#0000;background-position:100%;background-size:200% 100%;background-clip:text;animation:1.6s ease-in-out infinite uSmzmW_retry-shimmer}.uSmzmW_retryRow[open] .uSmzmW_retrySummary:after{transform:rotate(45deg)}.uSmzmW_retryDetails{overflow-wrap:anywhere;font-size:var(--dsh-content-font-size-secondary,13px);line-height:calc(18px + var(--dsh-content-font-delta-secondary,0px));gap:2px;margin-top:3px;padding-left:14px;display:grid}.uSmzmW_retryDetailLabel{color:var(--dsw-alias-label-secondary)}.uSmzmW_turnErrorRow{font-size:var(--dsh-content-font-size-secondary,13px);line-height:calc(20px + var(--dsh-content-font-delta-secondary,0px));grid-template-columns:10px minmax(0,1fr) auto;align-items:start;gap:8px;padding:2px 0;display:grid}.uSmzmW_turnErrorDot{margin-top:5px}.uSmzmW_turnErrorCopy{overflow-wrap:anywhere;min-width:0}.uSmzmW_turnErrorTitle{color:var(--dsw-alias-state-error-primary);margin-right:6px;font-weight:600}.uSmzmW_turnErrorMessage{color:var(--dsw-alias-label-secondary)}.uSmzmW_turnErrorCode{color:var(--dsw-alias-label-tertiary);font:var(--dsw-font-markdown-code-block-small)}.uSmzmW_maxTokensTitle{color:var(--dsw-alias-state-warn-primary);margin-right:6px;font-weight:600}@keyframes uSmzmW_retry-shimmer{0%{background-position:100%}to{background-position:0}}@media (prefers-reduced-motion:reduce){.uSmzmW_retryRow[data-active] .uSmzmW_retryText{color:inherit;background:0 0;animation:none}}";
		...
		var MessageItem_module_css_default = {
			"bubble": "uSmzmW_bubble",
			"compactionBody": "uSmzmW_compactionBody",
			"compactionButton": "uSmzmW_compactionButton",
			"compactionContextIcon": "uSmzmW_compactionContextIcon",
			"compactionDisclosureIcon": "uSmzmW_compactionDisclosureIcon",
			"compactionLeading": "uSmzmW_compactionLeading",
			"compactionRow": "uSmzmW_compactionRow",
			"compactionSep": "uSmzmW_compactionSep",
			"compactionSummary": "uSmzmW_compactionSummary",
			"compactionTitle": "uSmzmW_compactionTitle",
			"contextRow": "uSmzmW_contextRow",
			"maxTokensTitle": "uSmzmW_maxTokensTitle",
			"referenceSummary": "uSmzmW_referenceSummary",
			"retry-shimmer": "uSmzmW_retry-shimmer",
			"retryDetailLabel": "uSmzmW_retryDetailLabel",
			"retryDetails": "uSmzmW_retryDetails",
			"retryRow": "uSmzmW_retryRow",
			"retrySummary": "uSmzmW_retrySummary",
			"retryText": "uSmzmW_retryText",
			"turnErrorCode": "uSmzmW_turnErrorCode",
			"turnErrorCopy": "uSmzmW_turnErrorCopy",
			"turnErrorDot": "uSmzmW_turnErrorDot",
			"turnErrorMessage": "uSmzmW_turnErrorMessage",
			"turnErrorRow": "uSmzmW_turnErrorRow",
			"turnErrorTitle": "uSmzmW_turnErrorTitle",
			"userRow": "uSmzmW_userRow",
			"userStack": "uSmzmW_userStack"
		};
		//#endregion
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:/private/tmp/claude-501/-Users-alex-Documents-Code-dataelem-dsh-desktop/8cafdb41-dc87-41ba-bba5-9afd99a08420/scratchpad/harness/packages/client/ui-chat/src/client/chat/ContextBody.module.css.mjs
		const css$14 = ".Ci7oYG_text{color:var(--dsw-alias-label-secondary);font:inherit;white-space:pre-wrap;overflow-wrap:anywhere;margin:0}.Ci7oYG_fields{border-top:1px solid var(--dsw-alias-line-secondary);flex-direction:column;gap:2px;margin:8px 0 0;padding-top:8px;display:flex}.Ci7oYG_field{gap:8px;min-width:0;display:flex}.Ci7oYG_fieldKey{min-width:96px;color:var(--dsw-alias-label-caption);flex:none}.Ci7oYG_fieldValue{min-width:0;color:var(--dsw-alias-label-tertiary);overflow-wrap:anywhere;flex:auto;margin:0}.Ci7oYG_files{flex-wrap:wrap;gap:4px 12px;margin:0 0 8px;padding:0;list-style:none;display:flex}.Ci7oYG_file{align-items:baseline;gap:6px;min-width:0;display:flex}.Ci7oYG_filePath{color:var(--dsw-alias-label-secondary);overflow-wrap:anywhere}.Ci7oYG_fileAction{color:var(--dsw-alias-label-caption)}.Ci7oYG_catalogNotice{color:var(--dsw-alias-label-caption);margin:0 0 6px}.Ci7oYG_entries{flex-direction:column;gap:4px;margin:0;padding:0;list-style:none;display:flex}.Ci7oYG_entry{gap:8px;min-width:0;display:flex}.Ci7oYG_entryName{color:var(--dsw-alias-label-secondary);flex:none}.Ci7oYG_entryDescription{min-width:0;color:var(--dsw-alias-label-tertiary);text-overflow:ellipsis;white-space:nowrap;flex:auto;overflow:hidden}.Ci7oYG_sections{flex-direction:column;gap:8px;margin:0;display:flex}.Ci7oYG_section{flex-direction:column;gap:2px;min-width:0;display:flex}.Ci7oYG_sectionName{color:var(--dsw-alias-label-caption)}.Ci7oYG_sectionText{color:var(--dsw-alias-label-secondary);white-space:pre-wrap;overflow-wrap:anywhere;margin:0}.Ci7oYG_relaySender{color:var(--dsw-alias-label-caption);overflow-wrap:anywhere;margin:0 0 6px}.Ci7oYG_recalls{flex-direction:column;gap:2px;margin:0 0 8px;padding:0;list-style:none;display:flex}.Ci7oYG_recall{gap:8px;min-width:0;display:flex}.Ci7oYG_recallLabel{color:var(--dsw-alias-label-secondary);overflow-wrap:anywhere}.Ci7oYG_recallCounts{color:var(--dsw-alias-label-caption);flex:none}";
		...
		var ContextBody_module_css_default = {
			"catalogNotice": "Ci7oYG_catalogNotice",
			"entries": "Ci7oYG_entries",
			"entry": "Ci7oYG_entry",
			"entryDescription": "Ci7oYG_entryDescription",
			"entryName": "Ci7oYG_entryName",
			"field": "Ci7oYG_field",
			"fieldKey": "Ci7oYG_fieldKey",
			"fieldValue": "Ci7oYG_fieldValue",
			"fields": "Ci7oYG_fields",
			"file": "Ci7oYG_file",
			"fileAction": "Ci7oYG_fileAction",
			"filePath": "Ci7oYG_filePath",
			"files": "Ci7oYG_files",
			"recall": "Ci7oYG_recall",
			"recallCounts": "Ci7oYG_recallCounts",
			"recallLabel": "Ci7oYG_recallLabel",
			"recalls": "Ci7oYG_recalls",
			"relaySender": "Ci7oYG_relaySender",
			"section": "Ci7oYG_section",
			"sectionName": "Ci7oYG_sectionName",
			"sectionText": "Ci7oYG_sectionText",
			"sections": "Ci7oYG_sections",
			"text": "Ci7oYG_text"
		};
		//#endregion
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:/private/tmp/claude-501/-Users-alex-Documents-Code-dataelem-dsh-desktop/8cafdb41-dc87-41ba-bba5-9afd99a08420/scratchpad/harness/packages/client/ui-chat/src/client/chat/ContextInjectionRow.module.css.mjs
		const css$13 = ".PuIhMW_root{min-width:0}.PuIhMW_root[data-open]{padding-bottom:4px}.PuIhMW_chevron{color:var(--dsw-alias-label-secondary)}.PuIhMW_sep{background:var(--dsw-alias-label-caption);border-radius:1px;flex:none;width:2px;height:2px;margin:0 8px}.PuIhMW_source{min-width:0;color:var(--dsw-alias-label-tertiary);font-size:var(--dsh-content-font-size-secondary,13px);line-height:calc(24px + var(--dsh-content-font-delta,0px));text-overflow:ellipsis;white-space:nowrap;flex:none;overflow:hidden}.PuIhMW_summary{min-width:0;color:var(--dsw-alias-label-tertiary);font-size:var(--dsh-content-font-size-secondary,13px);line-height:calc(24px + var(--dsh-content-font-delta,0px));text-overflow:ellipsis;white-space:nowrap;flex:auto;overflow:hidden}.PuIhMW_body{box-sizing:border-box;width:calc(100% - 22px - var(--dsh-content-font-delta,0px));max-height:141px;margin:4px 0 0 calc(22px + var(--dsh-content-font-delta,0px));background:var(--dsw-alias-markdown-code-block);color:var(--dsw-alias-label-tertiary);font:400 11px/16px var(--ds-font-family-code);border:none;border-radius:8px;padding:10px 16px 12px 12px;overflow:auto}";
		...
		var ContextInjectionRow_module_css_default = {
			"body": "PuIhMW_body",
			"chevron": "PuIhMW_chevron",
			"root": "PuIhMW_root",
			"sep": "PuIhMW_sep",
			"source": "PuIhMW_source",
			"summary": "PuIhMW_summary"
		};
		//#endregion
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:/private/tmp/claude-501/-Users-alex-Documents-Code-dataelem-dsh-desktop/8cafdb41-dc87-41ba-bba5-9afd99a08420/scratchpad/harness/packages/client/ui-chat/src/client/chat/MessageIconActions.module.css.mjs
		const css$12 = ".npc0Lq_actions{height:calc(28px + var(--dsh-content-font-delta,0px));align-items:center;gap:10px;display:flex}.npc0Lq_timeStart{font-size:var(--dsh-content-font-size,14px);line-height:calc(24px + var(--dsh-content-font-delta,0px));color:var(--dsw-alias-label-tertiary);white-space:nowrap;padding-right:12px}.npc0Lq_timeEnd{font-size:var(--dsh-content-font-size,14px);line-height:calc(24px + var(--dsh-content-font-delta,0px));color:var(--dsw-alias-label-tertiary);white-space:nowrap;padding-left:12px}.npc0Lq_runTimeDot{margin:0 10px}@media (hover:hover){[data-time-hover-root] :is(.npc0Lq_timeStart,.npc0Lq_timeEnd){opacity:0;transition:opacity 80ms}[data-time-hover-root]:hover :is(.npc0Lq_timeStart,.npc0Lq_timeEnd),[data-time-hover-root]:focus-within :is(.npc0Lq_timeStart,.npc0Lq_timeEnd){opacity:1}}.npc0Lq_action{width:calc(28px + var(--dsh-content-font-delta,0px));height:calc(28px + var(--dsh-content-font-delta,0px));color:var(--dsw-alias-label-tertiary);cursor:pointer;background:0 0;border:none;border-radius:28px;justify-content:center;align-items:center;padding:6px;display:inline-flex}.npc0Lq_action svg{width:calc(16px + var(--dsh-content-font-delta,0px));height:calc(16px + var(--dsh-content-font-delta,0px))}.npc0Lq_action:hover{background:var(--dsw-alias-interactive-bg-hover);color:var(--dsw-alias-label-secondary)}.npc0Lq_action[data-unavailable]{cursor:default;opacity:.4}.npc0Lq_action[data-unavailable]:hover{color:var(--dsw-alias-label-tertiary);background:0 0}.npc0Lq_visuallyHidden{clip:rect(0 0 0 0);white-space:nowrap;width:1px;height:1px;position:absolute;overflow:hidden}";
		...
		var MessageIconActions_module_css_default = {
			"action": "npc0Lq_action",
			"actions": "npc0Lq_actions",
			"runTimeDot": "npc0Lq_runTimeDot",
			"timeEnd": "npc0Lq_timeEnd",
			"timeStart": "npc0Lq_timeStart",
			"visuallyHidden": "npc0Lq_visuallyHidden"
		};
		//#endregion
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:/private/tmp/claude-501/-Users-alex-Documents-Code-dataelem-dsh-desktop/8cafdb41-dc87-41ba-bba5-9afd99a08420/scratchpad/harness/packages/client/ui-chat/src/client/chat/ChatView.module.css.mjs
		const css$11 = "._7mWUNa_root{flex-direction:column;flex:auto;min-height:0;display:flex;position:relative}._7mWUNa_scroll{min-height:0;padding:16px calc(var(--dsh-composer-side-clearance) + 16px);flex:auto;overflow-y:auto;container-type:inline-size}[data-conversation-scroll] ._7mWUNa_root{flex:none;height:auto;min-height:auto}[data-conversation-scroll] ._7mWUNa_scroll{flex:none;min-height:auto;overflow:visible}._7mWUNa_column{max-width:var(--dsh-chat-content-width);flex-direction:column;width:100%;margin:0 auto;display:flex}._7mWUNa_column>:not([hidden]):not(._7mWUNa_flowItem:empty)~:not([hidden]):not(._7mWUNa_flowItem:empty){margin-top:var(--dsh-chat-flow-gap,16px)}._7mWUNa_flowItem{min-width:0}._7mWUNa_flowItem[data-turn-process-answer]{--dsh-chat-flow-gap:8px}._7mWUNa_flowItem:empty{display:none}._7mWUNa_callRow{border-radius:6px}._7mWUNa_turnStatus{height:calc(26px + var(--dsh-content-font-delta,0px));font:var(--dsw-font-s-strong-14);font-size:var(--dsh-content-font-size,14px);line-height:calc(22px + var(--dsh-content-font-delta,0px));white-space:nowrap;background:linear-gradient(90deg, var(--dsw-static-deepseek-500) 0%, var(--dsw-static-deepseek-500) 40%, var(--dsw-static-deepseek-200) 50%, var(--dsw-static-deepseek-500) 60%, var(--dsw-static-deepseek-500) 100%);color:#0000;-webkit-text-fill-color:transparent;background-position:100% 0;background-size:250% 100%;-webkit-background-clip:text;background-clip:text;flex:none;align-self:flex-start;align-items:center;animation:1.8s linear infinite _7mWUNa_dsh-turn-status-shimmer;display:inline-flex}._7mWUNa_turnStatusClock{font:var(--dsw-font-xs-13);font-size:var(--dsh-content-font-size-secondary,13px);line-height:calc(20px + var(--dsh-content-font-delta-secondary,0px));font-variant-numeric:tabular-nums;color:var(--dsw-alias-label-caption);-webkit-text-fill-color:var(--dsw-alias-label-caption);margin-left:8px;font-weight:400}@keyframes _7mWUNa_dsh-turn-status-shimmer{to{background-position:0 0}}@media (prefers-reduced-motion:reduce){._7mWUNa_turnStatus{background-position:0 0;background-size:100% 100%;animation:none}}._7mWUNa_hint{color:var(--dsw-alias-label-tertiary);font-size:var(--dsh-content-font-size-secondary,13px);line-height:calc(18px + var(--dsh-content-font-delta-secondary,0px))}._7mWUNa_openError{color:var(--dsw-alias-state-error-primary);font-size:var(--dsh-content-font-size-secondary,13px);line-height:calc(18px + var(--dsh-content-font-delta-secondary,0px))}._7mWUNa_older{justify-content:center;display:flex}._7mWUNa_older button{color:var(--dsw-alias-label-secondary);background:var(--dsw-alias-interactive-bg-hover-solid);cursor:pointer;border:none;border-radius:14px;padding:4px 12px;font-size:12px}._7mWUNa_older button:disabled{cursor:default;opacity:.6}._7mWUNa_toBottomSlot{z-index:8;height:0;padding-right:max(0px, calc((100% - var(--dsh-chat-content-width)) / 2));pointer-events:none;justify-content:flex-end;display:flex;position:sticky;bottom:16px}[data-conversation-scroll] ._7mWUNa_toBottomSlot{bottom:calc(var(--dsh-composer-height,152px) + 16px)}._7mWUNa_toBottom{border:1px solid var(--dsw-alias-border-l2);width:34px;height:34px;color:var(--dsw-alias-label-primary);background:var(--dsw-alias-button-floating-fill);box-shadow:var(--dsw-shadow-lv2);cursor:pointer;pointer-events:auto;border-radius:100px;justify-content:center;align-items:center;margin-top:-34px;padding:0;display:flex}._7mWUNa_toBottom:hover{background:var(--dsw-alias-button-floating-hover)}._7mWUNa_modalAction{min-width:72px}";
		...
		var ChatView_module_css_default = {
			"callRow": "_7mWUNa_callRow",
			"column": "_7mWUNa_column",
			"dsh-turn-status-shimmer": "_7mWUNa_dsh-turn-status-shimmer",
			"flowItem": "_7mWUNa_flowItem",
			"hint": "_7mWUNa_hint",
			"modalAction": "_7mWUNa_modalAction",
			"older": "_7mWUNa_older",
			"openError": "_7mWUNa_openError",
			"root": "_7mWUNa_root",
			"scroll": "_7mWUNa_scroll",
			"toBottom": "_7mWUNa_toBottom",
			"toBottomSlot": "_7mWUNa_toBottomSlot",
			"turnStatus": "_7mWUNa_turnStatus",
			"turnStatusClock": "_7mWUNa_turnStatusClock"
		};
		//#endregion
		...
		//#endregion
		//#region \0dsh-css:/private/tmp/claude-501/-Users-alex-Documents-Code-dataelem-dsh-desktop/8cafdb41-dc87-41ba-bba5-9afd99a08420/scratchpad/harness/packages/client/ui-chat/src/client/chat/TurnNavigator.module.css.mjs
		const css$10 = "._2UZLrG_slot{z-index:6;pointer-events:none;height:0;position:sticky;top:0}._2UZLrG_rail{--turn-rail-band:calc(var(--dsh-conversation-viewport-height,100dvh) - var(--dsh-composer-height,152px));--turn-preview-height:100px;top:calc(var(--turn-rail-band) / 2);right:calc(12px - (var(--dsh-composer-side-clearance) + 16px));width:28px;height:min(var(--turn-natural-height), max(0px, calc(var(--turn-rail-band) - 64px)), 420px);cursor:pointer;pointer-events:auto;transition:height .22s cubic-bezier(.2,.8,.2,1);position:absolute;transform:translateY(-50%)}._2UZLrG_marks{inset:var(--turn-rail-inset) 0;position:absolute}._2UZLrG_markPosition{top:min(var(--turn-natural-position), var(--turn-position));height:10px;transition:top .22s cubic-bezier(.2,.8,.2,1);animation:.15s ease-out _2UZLrG_dsh-turn-mark-enter;position:absolute;left:0;right:0;transform:translateY(-50%)}._2UZLrG_mark{cursor:pointer;pointer-events:none;background:0 0;border:0;border-radius:8px;width:20px;padding:0;position:absolute;inset:0 0 0 auto}._2UZLrG_mark:before{background:var(--dsw-alias-border-l4);content:\"\";border-radius:2px;width:12px;height:2px;transition:width .14s,background-color .14s;position:absolute;top:50%;right:0;transform:translateY(-50%)}._2UZLrG_markPreview:before{background:var(--dsw-alias-label-tertiary);width:18px}._2UZLrG_markActive:before{background:var(--dsw-alias-label-primary);width:20px}._2UZLrG_mark:focus-visible:before{background:var(--dsw-alias-state-business-primary);width:20px}._2UZLrG_mark:focus-visible{outline:1px solid var(--dsw-alias-state-business-primary);outline-offset:2px}._2UZLrG_preview{top:clamp(0px, calc(min(var(--turn-natural-position), var(--turn-position)) + var(--turn-rail-inset) - var(--turn-preview-height) / 2), calc(100% - var(--turn-preview-height)));box-sizing:border-box;width:min(300px,100cqw - 120px);max-height:var(--turn-preview-height);border:1px solid var(--dsw-alias-border-l2);color:var(--dsw-alias-label-primary);background:var(--dsw-alias-bg-layer-1);box-shadow:var(--dsw-shadow-lv2);pointer-events:none;border-radius:10px;padding:10px 12px;transition:top .14s cubic-bezier(.2,.8,.2,1);animation:.12s ease-out _2UZLrG_dsh-turn-preview-enter;position:absolute;right:calc(100% + 10px);overflow:hidden}._2UZLrG_previewPrompt,._2UZLrG_previewResponse{-webkit-box-orient:vertical;display:-webkit-box;overflow:hidden}._2UZLrG_previewPrompt{font:var(--dsw-font-xs-strong-13);-webkit-line-clamp:2}._2UZLrG_previewResponse{color:var(--dsw-alias-label-caption);font:var(--dsw-font-xxs-12);-webkit-line-clamp:2;margin-top:4px}@keyframes _2UZLrG_dsh-turn-mark-enter{0%{opacity:0}to{opacity:1}}@keyframes _2UZLrG_dsh-turn-preview-enter{0%{opacity:0;transform:translate(4px)}to{opacity:1;transform:translate(0)}}@container (width<=900px){._2UZLrG_slot{display:none}}@media (prefers-reduced-motion:reduce){._2UZLrG_rail,._2UZLrG_markPosition,._2UZLrG_mark:before,._2UZLrG_preview{transition:none;animation:none}}";
		...
		var TurnNavigator_module_css_default = {
			"dsh-turn-mark-enter": "_2UZLrG_dsh-turn-mark-enter",
			"dsh-turn-preview-enter": "_2UZLrG_dsh-turn-preview-enter",
			"mark": "_2UZLrG_mark",
			"markActive": "_2UZLrG_markActive",
			"markPosition": "_2UZLrG_markPosition",
			"markPreview": "_2UZLrG_markPreview",
			"marks": "_2UZLrG_marks",
			"preview": "_2UZLrG_preview",
			"previewPrompt": "_2UZLrG_previewPrompt",
			"previewResponse": "_2UZLrG_previewResponse",
			"rail": "_2UZLrG_rail",
			"slot": "_2UZLrG_slot"
		};
		//#endregion
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:/private/tmp/claude-501/-Users-alex-Documents-Code-dataelem-dsh-desktop/8cafdb41-dc87-41ba-bba5-9afd99a08420/scratchpad/harness/packages/client/ui-chat/src/client/chat/accessibility.module.css.mjs
		const css$9 = ".m-_jvW_visuallyHidden{clip:rect(0 0 0 0);white-space:nowrap;width:1px;height:1px;position:absolute;overflow:hidden}";
		...
		var accessibility_module_css_default = { "visuallyHidden": "m-_jvW_visuallyHidden" };
		//#endregion
		//#region \0dsh-css:/private/tmp/claude-501/-Users-alex-Documents-Code-dataelem-dsh-desktop/8cafdb41-dc87-41ba-bba5-9afd99a08420/scratchpad/harness/packages/client/ui-chat/src/client/chat/ReasoningRow.module.css.mjs
		const css$8 = ".Z-o8aa_root{flex-direction:column;display:flex}.Z-o8aa_row{position:relative;overflow:hidden}.Z-o8aa_root[data-state=running] .Z-o8aa_row:after{content:\"\";inset-block:0;background:linear-gradient(90deg, transparent 0%, color-mix(in srgb, var(--dsw-alias-bg-base) 60%, transparent) 55%, transparent 100%);pointer-events:none;width:300px;animation:2.6s ease-out infinite Z-o8aa_dsh-reasoning-row-sweep;position:absolute;left:0}@keyframes Z-o8aa_dsh-reasoning-row-sweep{0%{left:-300px}90%,to{left:100%}}.Z-o8aa_leading{flex-shrink:0}.Z-o8aa_chevron{color:var(--dsw-alias-label-secondary)}.Z-o8aa_title{font-weight:400}.Z-o8aa_separator{background:var(--dsw-alias-label-caption);border-radius:1px;flex:none;width:2px;height:2px;margin:0 8px}.Z-o8aa_summary{min-width:0;color:var(--dsw-alias-label-tertiary);font-size:var(--dsh-content-font-size-secondary,13px);line-height:calc(20px + var(--dsh-content-font-delta-secondary,0px));text-overflow:ellipsis;white-space:nowrap;flex:auto;overflow:hidden}.Z-o8aa_summary[data-follow-end]{text-overflow:clip}.Z-o8aa_thinkBody{padding:4px 0 4px calc(22px + var(--dsh-content-font-delta,0px));color:var(--dsw-alias-label-tertiary);font-size:var(--dsh-content-font-size-secondary,13px);line-height:calc(20px + var(--dsh-content-font-delta-secondary,0px));white-space:pre-wrap;word-break:break-word}@media (prefers-reduced-motion:reduce){.Z-o8aa_root[data-state=running] .Z-o8aa_row:after{animation:none}}";
		...
		var ReasoningRow_module_css_default = {
			"chevron": "Z-o8aa_chevron",
			"dsh-reasoning-row-sweep": "Z-o8aa_dsh-reasoning-row-sweep",
			"leading": "Z-o8aa_leading",
			"root": "Z-o8aa_root",
			"row": "Z-o8aa_row",
			"separator": "Z-o8aa_separator",
			"summary": "Z-o8aa_summary",
			"thinkBody": "Z-o8aa_thinkBody",
			"title": "Z-o8aa_title"
		};
		//#endregion
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:/private/tmp/claude-501/-Users-alex-Documents-Code-dataelem-dsh-desktop/8cafdb41-dc87-41ba-bba5-9afd99a08420/scratchpad/harness/packages/client/ui-chat/src/client/chat/AssistantMarkdown.module.css.mjs
		const css$7 = ".JfTm6W_root{font-size:var(--dsh-content-font-size,14px);line-height:calc(24px + var(--dsh-content-font-delta,0px));color:var(--dsw-alias-label-primary);flex-direction:column;display:flex}.JfTm6W_body{flex-direction:column;gap:16px;display:flex}.JfTm6W_body .md-table-wide{--dsh-table-spare:max(0px, calc((100cqw - var(--dsh-chat-content-width)) / 2));--dsh-table-lead:calc(var(--dsh-table-spare) + min(var(--dsh-chat-content-width), 100cqw) - 100%);box-sizing:border-box;width:calc(100% + var(--dsh-table-lead) + var(--dsh-table-spare));max-width:none;margin-left:calc(-1 * var(--dsh-table-lead));padding-left:var(--dsh-table-lead)}.JfTm6W_body>[data-turn-process-inline][hidden]{margin-bottom:-16px}.JfTm6W_stopped{background:var(--dsw-alias-interactive-bg-hover);color:var(--dsw-alias-label-tertiary);border-radius:6px;align-self:flex-start;padding:0 6px;font-size:11px;line-height:18px}.JfTm6W_actions{margin-top:16px;margin-left:-6px}";
		...
		var AssistantMarkdown_module_css_default = {
			"actions": "JfTm6W_actions",
			"body": "JfTm6W_body",
			"root": "JfTm6W_root",
			"stopped": "JfTm6W_stopped"
		};
		//#endregion
		...
		//#endregion
		//#region \0dsh-css:/private/tmp/claude-501/-Users-alex-Documents-Code-dataelem-dsh-desktop/8cafdb41-dc87-41ba-bba5-9afd99a08420/scratchpad/harness/packages/client/ui-chat/src/client/chat/GenericCommandCard.module.css.mjs
		const css$6 = ".St9zsG_root{flex-direction:column;display:flex}.St9zsG_row{position:relative;overflow:hidden}.St9zsG_root[data-state=running] .St9zsG_row:after{content:\"\";inset-block:0;background:linear-gradient(90deg, transparent 0%, color-mix(in srgb, var(--dsw-alias-bg-base) 60%, transparent) 55%, transparent 100%);pointer-events:none;width:300px;animation:2.6s ease-out infinite St9zsG_dsh-command-row-sweep;position:absolute;left:0}@keyframes St9zsG_dsh-command-row-sweep{0%{left:-300px}90%,to{left:100%}}.St9zsG_leading{flex-shrink:0}.St9zsG_chevron{color:var(--dsw-alias-label-secondary)}.St9zsG_title{font-weight:400}.St9zsG_separator{background:var(--dsw-alias-label-caption);border-radius:1px;flex:none;width:2px;height:2px;margin:0 8px}.St9zsG_summary{min-width:0;color:var(--dsw-alias-label-tertiary);font-size:var(--dsh-content-font-size-secondary,13px);line-height:calc(24px + var(--dsh-content-font-delta,0px));text-overflow:ellipsis;white-space:nowrap;flex:auto;overflow:hidden}.St9zsG_summary[data-error],.St9zsG_body[data-error]{color:var(--dsw-alias-state-error-primary)}.St9zsG_body{border:1px solid var(--dsw-alias-border-l1);background:var(--dsw-alias-markdown-code-block);max-height:260px;color:var(--dsw-alias-label-primary);font:var(--dsw-font-markdown-code-block-small);white-space:pre-wrap;border-radius:12px;margin:4px 0 4px 4px;padding:12px 16px;overflow:auto}@media (prefers-reduced-motion:reduce){.St9zsG_root[data-state=running] .St9zsG_row:after{animation:none}}";
		...
		var GenericCommandCard_module_css_default = {
			"body": "St9zsG_body",
			"chevron": "St9zsG_chevron",
			"dsh-command-row-sweep": "St9zsG_dsh-command-row-sweep",
			"leading": "St9zsG_leading",
			"root": "St9zsG_root",
			"row": "St9zsG_row",
			"separator": "St9zsG_separator",
			"summary": "St9zsG_summary",
			"title": "St9zsG_title"
		};
		//#endregion
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:/private/tmp/claude-501/-Users-alex-Documents-Code-dataelem-dsh-desktop/8cafdb41-dc87-41ba-bba5-9afd99a08420/scratchpad/harness/packages/client/ui-chat/src/client/chat/TurnProcessNodeView.module.css.mjs
		const css$5 = ".KJf5SG_root{box-sizing:border-box;border:none;border-bottom:1px solid var(--dsw-alias-border-l2);width:100%;min-width:0;height:33px;color:var(--dsw-alias-label-secondary);cursor:pointer;text-align:left;background:0 0;align-items:center;padding:0 0 8px;display:flex}.KJf5SG_root:not([data-open]){margin-bottom:8px}.KJf5SG_chevron{width:16px;height:16px;color:var(--dsw-alias-label-tertiary);flex:none;margin-left:6px;transition:transform .1s;transform:rotate(-90deg)}.KJf5SG_root[data-open] .KJf5SG_chevron{transform:rotate(0)}.KJf5SG_label{text-overflow:ellipsis;white-space:nowrap;min-width:0;font-size:14px;line-height:24px;overflow:hidden}@media (prefers-reduced-motion:reduce){.KJf5SG_chevron{transition:none}}";
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:/private/tmp/claude-501/-Users-alex-Documents-Code-dataelem-dsh-desktop/8cafdb41-dc87-41ba-bba5-9afd99a08420/scratchpad/harness/packages/client/ui-chat/src/client/chat/TurnUsageDisclosure.module.css.mjs
		const css$4 = ".B4nxEW_root{min-width:0}.B4nxEW_root[data-open]{padding-bottom:4px}.B4nxEW_root [data-disclosure-row]:focus-visible{outline:2px solid var(--dsw-alias-label-tertiary);outline-offset:-2px;border-radius:6px}.B4nxEW_chevron{color:var(--dsw-alias-label-secondary)}.B4nxEW_separator{background:var(--dsw-alias-label-caption);border-radius:1px;flex:none;width:2px;height:2px;margin:0 8px}.B4nxEW_summary{min-width:0;color:var(--dsw-alias-label-tertiary);font-size:var(--dsh-content-font-size-secondary,13px);font-variant-numeric:tabular-nums;line-height:calc(24px + var(--dsh-content-font-delta,0px));text-overflow:ellipsis;white-space:nowrap;overflow:hidden}.B4nxEW_details{box-sizing:border-box;width:calc(100% - 22px - var(--dsh-content-font-delta,0px));margin:4px 0 0 calc(22px + var(--dsh-content-font-delta,0px));background:var(--dsw-alias-markdown-code-block);color:var(--dsw-alias-label-tertiary);border-radius:8px;grid-template-columns:minmax(76px,auto) minmax(0,1fr);gap:6px 16px;padding:10px 16px 12px 12px;font-size:12px;line-height:18px;display:grid}.B4nxEW_details dt,.B4nxEW_details dd{min-width:0;margin:0}.B4nxEW_details dd{color:var(--dsw-alias-label-secondary);font-variant-numeric:tabular-nums;text-align:right}.B4nxEW_details .B4nxEW_route{overflow-wrap:anywhere}.B4nxEW_reasoning{color:var(--dsw-alias-label-tertiary);white-space:nowrap}.B4nxEW_totalLabel,.B4nxEW_details .B4nxEW_totalValue{border-top:1px solid var(--dsw-alias-separator-primary);color:var(--dsw-alias-label-primary);padding-top:6px}@media (width<=480px){.B4nxEW_details{gap-inline:10px;grid-template-columns:minmax(72px,auto) minmax(0,1fr)}}";
		...
		var TurnUsageDisclosure_module_css_default = {
			"chevron": "B4nxEW_chevron",
			"details": "B4nxEW_details",
			"reasoning": "B4nxEW_reasoning",
			"root": "B4nxEW_root",
			"route": "B4nxEW_route",
			"separator": "B4nxEW_separator",
			"summary": "B4nxEW_summary",
			"totalLabel": "B4nxEW_totalLabel",
			"totalValue": "B4nxEW_totalValue"
		};
		//#endregion
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:/private/tmp/claude-501/-Users-alex-Documents-Code-dataelem-dsh-desktop/8cafdb41-dc87-41ba-bba5-9afd99a08420/scratchpad/harness/packages/client/ui-chat/src/client/chat/TurnTailNodeView.module.css.mjs
		const css$3 = ".y_cg-W_root{flex-direction:column;gap:16px;display:flex}.y_cg-W_footer{flex-direction:column;gap:4px;min-width:0;display:flex}.y_cg-W_actions{margin-left:-6px}";
		...
		var TurnTailNodeView_module_css_default = {
			"actions": "y_cg-W_actions",
			"footer": "y_cg-W_footer",
			"root": "y_cg-W_root"
		};
		//#endregion
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:/private/tmp/claude-501/-Users-alex-Documents-Code-dataelem-dsh-desktop/8cafdb41-dc87-41ba-bba5-9afd99a08420/scratchpad/harness/packages/client/ui-chat/src/client/chat/StatsLine.module.css.mjs
		const css$2 = ".uCgNAq_root{text-align:center;max-width:var(--dsh-chat-content-width);box-sizing:border-box;width:100%;padding:4px calc(var(--dsh-composer-side-clearance) + 16px) 0px;font-size:var(--dsh-content-font-size-secondary,13px);line-height:calc(20px + var(--dsh-content-font-delta-secondary,0px));color:var(--dsw-alias-label-tertiary);white-space:nowrap;text-overflow:ellipsis;margin:0 auto;display:block;overflow:hidden}.uCgNAq_sep{color:var(--dsw-alias-separator-primary);margin:0 10px}";
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:/private/tmp/claude-501/-Users-alex-Documents-Code-dataelem-dsh-desktop/8cafdb41-dc87-41ba-bba5-9afd99a08420/scratchpad/harness/packages/client/ui-chat/src/client/details/DetailsPanel.module.css.mjs
		const css$1 = ".k1dWFG_root{border-left:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-base);flex-direction:column;min-width:0;height:100%;display:flex}.k1dWFG_header{border-bottom:1px solid var(--dsw-alias-border-l2);justify-content:space-between;align-items:center;gap:8px;padding:14px 12px 12px;display:flex}.k1dWFG_title{color:var(--dsw-alias-label-primary);text-overflow:ellipsis;white-space:nowrap;font-size:14px;font-weight:500;line-height:20px;overflow:hidden}.k1dWFG_close{width:28px;height:28px;color:var(--dsw-alias-label-secondary);cursor:pointer;background:0 0;border:none;border-radius:999px;flex:none;place-items:center;display:grid}.k1dWFG_close:hover{background:var(--dsw-alias-interactive-bg-hover)}.k1dWFG_body{flex:1;min-height:0;padding:12px 16px;overflow-y:auto}.k1dWFG_empty{color:var(--dsw-alias-label-tertiary);padding:8px 0;font-size:13px;line-height:20px}.k1dWFG_section{margin-bottom:16px}.k1dWFG_sectionLabel{color:var(--dsw-alias-label-secondary);margin-bottom:6px;font-size:12px;font-weight:500;line-height:18px}.k1dWFG_code{background:var(--dsw-alias-markdown-code-block);font-family:var(--ds-font-family-code);color:var(--dsw-alias-label-primary);white-space:pre-wrap;word-break:break-word;border-radius:12px;margin:0;padding:16px;font-size:13px;line-height:22px}.k1dWFG_code[data-error]{color:var(--dsw-alias-state-error-primary)}";
		...
		var DetailsPanel_module_css_default = {
			...
			"code": "k1dWFG_code",
			"empty": "k1dWFG_empty",
			"header": "k1dWFG_header",
			"root": "k1dWFG_root",
			"section": "k1dWFG_section",
			"sectionLabel": "k1dWFG_sectionLabel",
			"title": "k1dWFG_title"
		};
		//#endregion
		...
		//#endregion
		//#region \0dsh-css:/private/tmp/claude-501/-Users-alex-Documents-Code-dataelem-dsh-desktop/8cafdb41-dc87-41ba-bba5-9afd99a08420/scratchpad/harness/packages/client/ui-chat/src/client/settings/TranscriptViewRow.module.css.mjs
		const css = "._2cSupW_row{border-bottom:1px solid var(--dsw-alias-border-l2);align-items:center;gap:8px;padding:16px 0;display:flex}._2cSupW_rowText{flex-direction:column;flex:1;gap:4px;min-width:0;padding-right:48px;display:flex}._2cSupW_title{color:var(--dsw-alias-label-primary);font-size:14px;font-weight:400;line-height:22px}._2cSupW_desc{color:var(--dsw-alias-label-tertiary);font-size:12px;font-weight:400;line-height:18px}._2cSupW_selector{background:var(--dsw-alias-bg-module-platform);height:36px;font:inherit;color:var(--dsw-alias-label-primary);cursor:pointer;border:none;border-radius:18px;align-items:center;gap:12px;padding:0 14px;font-size:14px;line-height:22px;display:inline-flex}._2cSupW_selector:hover{background:var(--dsw-alias-interactive-bg-hover)}._2cSupW_chevron{flex:none}";
		...
		var TranscriptViewRow_module_css_default = {
			"chevron": "_2cSupW_chevron",
			"desc": "_2cSupW_desc",
			"row": "_2cSupW_row",
			"rowText": "_2cSupW_rowText",
			"selector": "_2cSupW_selector",
			"title": "_2cSupW_title"
		};
		//#endregion
