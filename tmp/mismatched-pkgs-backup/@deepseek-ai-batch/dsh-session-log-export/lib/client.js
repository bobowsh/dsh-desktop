window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:/private/tmp/claude-501/-Users-alex-Documents-Code-dataelem-dsh-desktop/8cafdb41-dc87-41ba-bba5-9afd99a08420/scratchpad/harness/packages/session-query/session-log-export/src/client/HeaderAction.module.css.mjs
		const css = ".nYKbOa_sessionLogButton{border:1px solid var(--dsw-alias-border-l2);min-width:111px;height:32px;color:var(--dsw-alias-label-primary);font-family:var(--dsw-font-family);cursor:pointer;background:0 0;border-radius:18px;justify-content:center;align-items:center;gap:4px;padding:6px 12px;font-size:13px;font-weight:400;line-height:20px;display:inline-flex}.nYKbOa_sessionLogButton:hover:not(:disabled){background:var(--dsw-alias-interactive-bg-hover)}.nYKbOa_sessionLogButton:disabled{color:var(--dsw-alias-label-dimmed);cursor:wait}.nYKbOa_sessionLogButton span,.nYKbOa_sessionLogButton svg{flex:none}.nYKbOa_sessionLogButton span{white-space:nowrap}";
		...
		var HeaderAction_module_css_default = { "sessionLogButton": "nYKbOa_sessionLogButton" };
		//#endregion
