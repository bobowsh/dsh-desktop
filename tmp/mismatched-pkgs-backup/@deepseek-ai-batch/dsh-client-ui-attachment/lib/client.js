window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		//#endregion
		//#region \0dsh-css:/private/tmp/claude-501/-Users-alex-Documents-Code-dataelem-dsh-desktop/8cafdb41-dc87-41ba-bba5-9afd99a08420/scratchpad/harness/packages/client/ui-attachment/src/AttachmentRail.module.css.mjs
		const css$4 = ".pp6lBW_root{min-width:0;position:relative}.pp6lBW_rail{scrollbar-width:none;--dsh-scrollbar-thumb:var(--dsw-alias-scrollbar-bg-l2);--dsh-scrollbar-thumb-hover:var(--dsw-alias-scrollbar-hover-l2);gap:10px;display:flex;overflow:auto hidden}.pp6lBW_rail::-webkit-scrollbar{display:none}.pp6lBW_item{flex:0 0 64px;width:64px;height:64px;position:relative}.pp6lBW_thumbnail{border:1px solid var(--dsw-alias-border-l2-darkmode-thin);background:var(--dsw-alias-interactive-bg-hover);cursor:zoom-in;border-radius:16px;width:64px;height:64px;padding:0;overflow:hidden}.pp6lBW_thumbnail img{object-fit:cover;width:100%;height:100%;display:block}.pp6lBW_remove{z-index:1;background:var(--dsw-alias-button-contrast-fill);width:18px;height:18px;color:var(--dsw-alias-label-primary-inverted);cursor:pointer;opacity:0;border:none;border-radius:50%;place-items:center;padding:0;transition:opacity .2s ease-in-out;display:grid;position:absolute;top:4px;right:4px}.pp6lBW_item:hover .pp6lBW_remove,.pp6lBW_remove:focus-visible{opacity:1}@media (pointer:coarse){.pp6lBW_remove{opacity:1}}@media (prefers-reduced-motion:reduce){.pp6lBW_remove{transition:none}}.pp6lBW_arrow{z-index:2;border:1px solid var(--dsw-alias-border-l2-darkmode-thin);background:var(--dsw-specific-input-major);width:24px;height:24px;color:var(--dsw-alias-label-secondary);box-shadow:var(--dsw-shadow-lv2);cursor:pointer;border-radius:999px;place-items:center;padding:0;display:grid;position:absolute;top:50%;transform:translateY(-50%)}.pp6lBW_arrow:hover{background:var(--dsw-alias-interactive-bg-hover-solid)}.pp6lBW_arrowLeft{left:4px}.pp6lBW_arrowRight{right:4px}";
		...
		var AttachmentRail_module_css_default = {
			"arrow": "pp6lBW_arrow",
			"arrowLeft": "pp6lBW_arrowLeft",
			"arrowRight": "pp6lBW_arrowRight",
			"item": "pp6lBW_item",
			"rail": "pp6lBW_rail",
			"remove": "pp6lBW_remove",
			"root": "pp6lBW_root",
			"thumbnail": "pp6lBW_thumbnail"
		};
		//#endregion
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:/private/tmp/claude-501/-Users-alex-Documents-Code-dataelem-dsh-desktop/8cafdb41-dc87-41ba-bba5-9afd99a08420/scratchpad/harness/packages/client/ui-attachment/src/DropOverlay.module.css.mjs
		const css$3 = "._47Xg9a_mask{z-index:1000;pointer-events:none;background-color:var(--dsw-alias-bg-mask-drop);backdrop-filter:blur(10px);justify-content:center;align-items:center;animation:.16s ease-out _47Xg9a_fade-in;display:flex;position:fixed;inset:0}@keyframes _47Xg9a_fade-in{0%{opacity:0}to{opacity:1}}@media (prefers-reduced-motion:reduce){._47Xg9a_mask{animation:none}}._47Xg9a_wrap{color:var(--dsw-alias-label-primary);text-align:center;flex-direction:column;align-items:center;margin-top:-3%;padding:0 40px;display:flex}._47Xg9a_illustration{width:115px;height:84px}._47Xg9a_title{font:var(--dsw-font-l-20);margin-top:16px}._47Xg9a_desc{font:var(--dsw-font-s-14);color:var(--dsw-alias-label-tertiary);white-space:pre-wrap;margin-top:16px}";
		...
		var DropOverlay_module_css_default = {
			"desc": "_47Xg9a_desc",
			"fade-in": "_47Xg9a_fade-in",
			"illustration": "_47Xg9a_illustration",
			"mask": "_47Xg9a_mask",
			"title": "_47Xg9a_title",
			"wrap": "_47Xg9a_wrap"
		};
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:/private/tmp/claude-501/-Users-alex-Documents-Code-dataelem-dsh-desktop/8cafdb41-dc87-41ba-bba5-9afd99a08420/scratchpad/harness/packages/client/ui-attachment/src/ImageLightbox.module.css.mjs
		const css$2 = ".SPpKkW_backdrop{z-index:1000;place-items:center;padding:40px;display:grid;position:fixed;inset:0}.SPpKkW_mask{background:var(--dsw-alias-bg-mask-1);backdrop-filter:var(--dsw-mask-blur);position:absolute;inset:0}.SPpKkW_image{object-fit:contain;background:var(--dsw-specific-input-major);max-width:min(100%,1600px);max-height:calc(100vh - 80px);box-shadow:var(--dsw-shadow-lv3);border-radius:12px;position:relative}.SPpKkW_close{z-index:1;border:1px solid var(--dsw-alias-border-l2-darkmode-thin);background:var(--dsw-specific-input-major);width:36px;height:36px;color:var(--dsw-alias-label-primary);cursor:pointer;border-radius:999px;place-items:center;display:grid;position:fixed;top:20px;right:20px}";
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:/private/tmp/claude-501/-Users-alex-Documents-Code-dataelem-dsh-desktop/8cafdb41-dc87-41ba-bba5-9afd99a08420/scratchpad/harness/packages/client/ui-attachment/src/client/ComposerAttachments.module.css.mjs
		const css$1 = ".DTGLsG_rail{min-width:0;padding:4px 12px 0}";
		...
		var ComposerAttachments_module_css_default = { "rail": "DTGLsG_rail" };
		//#endregion
		...
		//#endregion
		//#region \0dsh-css:/private/tmp/claude-501/-Users-alex-Documents-Code-dataelem-dsh-desktop/8cafdb41-dc87-41ba-bba5-9afd99a08420/scratchpad/harness/packages/client/ui-attachment/src/MessageImage.module.css.mjs
		const css = ".ljItvG_gallery{flex-wrap:wrap;gap:10px;max-width:100%;display:flex}.ljItvG_gallery[data-align=end]{justify-content:flex-end;align-self:flex-end}.ljItvG_gallery[data-align=start]{justify-content:flex-start;align-self:flex-start}.ljItvG_frame{border:1px solid var(--dsw-alias-border-l2-darkmode-thin);background:var(--dsw-alias-interactive-bg-hover);cursor:zoom-in;border-radius:16px;flex:none;place-items:center;min-width:44px;min-height:44px;padding:0;display:grid;overflow:hidden}.ljItvG_frame[data-variant=tile]{width:64px;min-width:64px;height:64px;min-height:64px}.ljItvG_frame img{object-fit:cover;width:100%;height:100%;display:block}.ljItvG_loading,.ljItvG_error{color:var(--dsw-alias-label-tertiary);font-size:12px;line-height:18px}.ljItvG_error{border:1px solid var(--dsw-alias-border-l2-darkmode-thin);background:var(--dsw-alias-interactive-bg-hover-danger);cursor:pointer;border-radius:10px;max-width:240px;padding:10px 12px}.ljItvG_error[data-variant=tile]{border-radius:16px;width:64px;height:64px;padding:4px;overflow:hidden}";
		...
		var MessageImage_module_css_default = {
			"error": "ljItvG_error",
			"frame": "ljItvG_frame",
			"gallery": "ljItvG_gallery",
			"loading": "ljItvG_loading"
		};
		//#endregion
