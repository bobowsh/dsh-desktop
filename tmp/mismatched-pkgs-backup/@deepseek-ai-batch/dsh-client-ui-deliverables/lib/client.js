window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:/private/tmp/claude-501/-Users-alex-Documents-Code-dataelem-dsh-desktop/8cafdb41-dc87-41ba-bba5-9afd99a08420/scratchpad/harness/packages/client/ui-deliverables/src/client/ProducedFiles.module.css.mjs
		const css = ".BqjVvG_root{grid-template-columns:max-content minmax(0,1fr);align-items:center;gap:6px 8px;margin-top:16px;font-size:13px;line-height:22px;display:grid;position:relative}.BqjVvG_label{color:var(--dsw-alias-label-tertiary);grid-area:1/1}.BqjVvG_row{flex-wrap:nowrap;grid-area:1/2;align-items:center;gap:8px;min-width:0;display:flex;overflow:hidden}.BqjVvG_file{text-overflow:ellipsis;white-space:nowrap;background:var(--dsw-alias-interactive-bg-hover);max-width:320px;color:var(--dsw-alias-label-secondary);font:inherit;cursor:pointer;border:none;border-radius:6px;flex:none;margin:0;padding:0 8px;overflow:hidden}.BqjVvG_file:hover{color:var(--dsw-alias-label-primary);text-decoration:underline}.BqjVvG_file:focus-visible,.BqjVvG_showFolder:focus-visible{box-shadow:inset 0 0 0 2px var(--dsw-alias-border-l3);outline:none}.BqjVvG_more{white-space:nowrap;color:var(--dsw-alias-label-tertiary);flex:none}.BqjVvG_showFolder{color:var(--dsw-alias-label-tertiary);font:inherit;cursor:pointer;background:0 0;border:none;border-radius:4px;grid-area:2/2;justify-self:start;margin:0;padding:0 2px;line-height:20px}.BqjVvG_showFolder:hover{color:var(--dsw-alias-label-secondary);text-decoration:underline}.BqjVvG_measure{visibility:hidden;pointer-events:none;contain:strict;width:0;height:0;position:absolute;overflow:hidden}.BqjVvG_probe{width:max-content;position:absolute;inset:0 auto auto 0}";
		...
		var ProducedFiles_module_css_default = {
			"file": "BqjVvG_file",
			"label": "BqjVvG_label",
			"measure": "BqjVvG_measure",
			"more": "BqjVvG_more",
			"probe": "BqjVvG_probe",
			"root": "BqjVvG_root",
			"row": "BqjVvG_row",
			"showFolder": "BqjVvG_showFolder"
		};
		//#endregion
