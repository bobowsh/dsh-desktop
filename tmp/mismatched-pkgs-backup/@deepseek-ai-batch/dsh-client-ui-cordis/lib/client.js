window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:/private/tmp/claude-501/-Users-alex-Documents-Code-dataelem-dsh-desktop/8cafdb41-dc87-41ba-bba5-9afd99a08420/scratchpad/harness/packages/extensions/ui-cordis/src/client/CordisRunRow.module.css.mjs
		const css$2 = "._70vqja_card{flex-direction:column;gap:8px;display:flex}._70vqja_row{align-items:center;min-height:32px;display:flex}._70vqja_icon{color:var(--dsw-alias-state-business-primary);flex:none;margin-right:8px;display:inline-flex}._70vqja_title{color:var(--dsw-alias-state-business-primary);flex:none;font-size:14px;font-weight:500;line-height:24px}._70vqja_separator{background:var(--dsw-alias-state-business-primary);border-radius:50%;flex:none;width:2px;height:2px;margin:0 8px}._70vqja_summary,._70vqja_error{min-width:0;color:var(--dsw-alias-label-secondary);text-overflow:ellipsis;white-space:nowrap;flex:1;font-size:13px;line-height:24px;overflow:hidden}._70vqja_error{color:var(--dsw-alias-state-error-primary)}._70vqja_status{color:var(--dsw-alias-label-caption);flex:none;margin-left:8px;font-size:12px;line-height:24px}._70vqja_card[data-cordis-status=awaiting-approval] ._70vqja_status,._70vqja_card[data-cordis-status=client-pending] ._70vqja_status{color:var(--dsw-alias-state-warn-label)}._70vqja_card[data-cordis-status=running] ._70vqja_status{color:var(--dsw-alias-state-success-primary)}._70vqja_card[data-cordis-status=failed] ._70vqja_status{color:var(--dsw-alias-state-error-primary)}._70vqja_inspect{width:24px;height:24px;color:var(--dsw-alias-label-tertiary);cursor:pointer;opacity:0;background:0 0;border:none;border-radius:999px;justify-content:center;align-items:center;margin-left:4px;padding:0;display:inline-flex}._70vqja_card:hover ._70vqja_inspect,._70vqja_inspect:focus-visible{opacity:1}._70vqja_inspect:hover{background:var(--dsw-alias-interactive-bg-hover)}._70vqja_message{background:var(--dsw-alias-button-ghost-active-fill);color:var(--dsw-alias-label-tertiary);border-radius:8px;padding:8px 12px;font-size:12px;line-height:18px}._70vqja_business{border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-base);border-radius:12px;min-width:0;overflow:hidden}._70vqja_output{border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-markdown-code-block);color:var(--dsw-alias-label-secondary);font:var(--dsw-font-markdown-code-block-small);white-space:pre-wrap;overflow-wrap:anywhere;border-radius:8px;margin:0;padding:10px 12px;overflow:auto}._70vqja_business ._70vqja_output{border:none;border-radius:0}";
		...
		var CordisRunRow_module_css_default = {
			"business": "_70vqja_business",
			"card": "_70vqja_card",
			"error": "_70vqja_error",
			"icon": "_70vqja_icon",
			"inspect": "_70vqja_inspect",
			"message": "_70vqja_message",
			"output": "_70vqja_output",
			"row": "_70vqja_row",
			"separator": "_70vqja_separator",
			"status": "_70vqja_status",
			"summary": "_70vqja_summary",
			"title": "_70vqja_title"
		};
		//#endregion
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:/private/tmp/claude-501/-Users-alex-Documents-Code-dataelem-dsh-desktop/8cafdb41-dc87-41ba-bba5-9afd99a08420/scratchpad/harness/packages/extensions/ui-cordis/src/client/CordisDefineRow.module.css.mjs
		const css$1 = ".aVS4EG_card{flex-direction:column;display:flex}.aVS4EG_card .aVS4EG_title,.aVS4EG_card .aVS4EG_chevron{color:var(--dsw-alias-state-business-primary)}.aVS4EG_title{flex:none;font-size:14px;font-weight:500;line-height:24px}.aVS4EG_row{gap:0}.aVS4EG_separator{background:var(--dsw-alias-state-business-primary);border-radius:1px;flex:none;width:2px;height:2px;margin:0 8px}.aVS4EG_name{text-overflow:ellipsis;white-space:nowrap;max-width:40%;color:var(--dsw-alias-label-secondary);flex:none;font-size:14px;line-height:24px;overflow:hidden}.aVS4EG_purpose{text-overflow:ellipsis;white-space:nowrap;min-width:0;color:var(--dsw-alias-label-tertiary);flex:auto;margin-left:8px;font-size:13px;line-height:24px;overflow:hidden}.aVS4EG_errorSummary{text-overflow:ellipsis;white-space:nowrap;min-width:0;color:var(--dsw-alias-state-error-primary);flex:auto;font-size:14px;line-height:24px;overflow:hidden}.aVS4EG_requestError{text-overflow:ellipsis;white-space:nowrap;max-width:40%;color:var(--dsw-alias-state-error-primary);flex:none;margin-left:8px;font-size:12px;line-height:24px;overflow:hidden}.aVS4EG_readout{flex:none;align-items:center;margin-left:8px;display:inline-flex}.aVS4EG_panelHint{color:var(--dsw-alias-label-caption);margin:4px 0 2px 4px;font-size:11px;line-height:16px}.aVS4EG_statusLabel{color:var(--dsw-alias-label-caption);font-size:12px;line-height:24px}.aVS4EG_approvalPrompt{text-overflow:ellipsis;white-space:nowrap;max-width:40%;color:var(--dsw-alias-label-secondary);flex:none;margin-left:8px;font-size:12px;line-height:24px;overflow:hidden}.aVS4EG_notice{text-overflow:ellipsis;white-space:nowrap;max-width:40%;color:var(--dsw-alias-label-caption);flex:none;margin-left:8px;font-size:12px;line-height:24px;overflow:hidden}.aVS4EG_switch{height:22px;padding:0 8px;font-size:12px}.aVS4EG_card[data-terminal] .aVS4EG_title,.aVS4EG_card[data-terminal] .aVS4EG_name,.aVS4EG_card[data-terminal] .aVS4EG_purpose,.aVS4EG_card[data-terminal] .aVS4EG_statusLabel{color:var(--dsw-alias-label-caption)}.aVS4EG_card[data-terminal] .aVS4EG_separator{background:var(--dsw-alias-label-caption)}.aVS4EG_bodyWrap{flex-direction:column;display:flex}.aVS4EG_sourceCard{flex-direction:column;margin:4px 0 4px 4px;display:flex}.aVS4EG_sourceTabs{border-bottom:1px solid var(--dsw-alias-border-l2);height:32px;display:flex}.aVS4EG_sourceTab{color:var(--dsw-alias-label-tertiary);cursor:pointer;font:var(--dsw-font-xs-13);background:0 0;border:0;padding:0 10px;position:relative}.aVS4EG_sourceTab:hover:not(:disabled){background:var(--dsw-alias-interactive-bg-hover);color:var(--dsw-alias-label-primary)}.aVS4EG_sourceTab:disabled{cursor:default;opacity:.4}.aVS4EG_sourceTabActive{color:var(--dsw-alias-state-business-primary)}.aVS4EG_sourceTabActive:after{background:var(--dsw-alias-state-business-primary);content:\"\";border-radius:1px 1px 0 0;height:2px;position:absolute;bottom:0;left:10px;right:10px}.aVS4EG_sourceTab:focus-visible{outline:1px solid var(--dsw-alias-state-business-primary);outline-offset:-1px}.aVS4EG_sourcePanel{max-height:260px;overflow:auto}.aVS4EG_sourceCode{margin:0}.aVS4EG_codeSection{flex-direction:column;max-height:260px;margin:4px 0 4px 4px;display:flex;overflow:auto}.aVS4EG_sectionLabel{color:var(--dsw-alias-label-caption);text-transform:uppercase;letter-spacing:.04em;flex:none;padding:2px 0;font-size:11px;font-weight:500;line-height:16px}.aVS4EG_output{border:1px solid var(--dsw-alias-border-l1);background:var(--dsw-alias-markdown-code-block);white-space:pre-wrap;overflow-wrap:anywhere;font:var(--dsw-font-markdown-code-block-small);color:var(--dsw-alias-label-secondary);border-radius:8px;margin:0;padding:8px 10px}.aVS4EG_output[data-error]{color:var(--dsw-alias-state-error-primary)}.aVS4EG_inspectButton{border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-base);color:var(--dsw-alias-label-secondary);cursor:pointer;opacity:0;border-radius:999px;align-self:flex-start;align-items:center;gap:4px;margin:4px 0 2px 4px;padding:2px 8px;font-size:11px;line-height:16px;transition:opacity .1s;display:inline-flex}.aVS4EG_card:hover .aVS4EG_inspectButton,.aVS4EG_inspectButton:focus-visible{opacity:1}.aVS4EG_inspectButton:hover{background:var(--dsw-alias-interactive-bg-hover-solid);color:var(--dsw-alias-label-primary)}.aVS4EG_visuallyHidden{clip:rect(0 0 0 0);white-space:nowrap;width:1px;height:1px;position:absolute;overflow:hidden}@media (prefers-reduced-motion:reduce){.aVS4EG_inspectButton{transition:none}}";
		...
		var CordisDefineRow_module_css_default = {
			"approvalPrompt": "aVS4EG_approvalPrompt",
			"bodyWrap": "aVS4EG_bodyWrap",
			"card": "aVS4EG_card",
			"chevron": "aVS4EG_chevron",
			"codeSection": "aVS4EG_codeSection",
			"errorSummary": "aVS4EG_errorSummary",
			"inspectButton": "aVS4EG_inspectButton",
			"name": "aVS4EG_name",
			"notice": "aVS4EG_notice",
			"output": "aVS4EG_output",
			"panelHint": "aVS4EG_panelHint",
			"purpose": "aVS4EG_purpose",
			"readout": "aVS4EG_readout",
			"requestError": "aVS4EG_requestError",
			"row": "aVS4EG_row",
			"sectionLabel": "aVS4EG_sectionLabel",
			"separator": "aVS4EG_separator",
			"sourceCard": "aVS4EG_sourceCard",
			"sourceCode": "aVS4EG_sourceCode",
			"sourcePanel": "aVS4EG_sourcePanel",
			"sourceTab": "aVS4EG_sourceTab",
			"sourceTabActive": "aVS4EG_sourceTabActive",
			"sourceTabs": "aVS4EG_sourceTabs",
			"statusLabel": "aVS4EG_statusLabel",
			"switch": "aVS4EG_switch",
			"title": "aVS4EG_title",
			"visuallyHidden": "aVS4EG_visuallyHidden"
		};
		//#endregion
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:/private/tmp/claude-501/-Users-alex-Documents-Code-dataelem-dsh-desktop/8cafdb41-dc87-41ba-bba5-9afd99a08420/scratchpad/harness/packages/extensions/ui-cordis/src/client/CordisPanel.module.css.mjs
		const css = ".Mb_bHa_layer{flex:none;align-items:center;width:100%;height:42px;margin:8px 0 0;display:flex;position:relative}.Mb_bHa_footerButtons{align-items:center;width:100%;display:flex}.Mb_bHa_badge{width:calc(100% + 4px);height:42px;color:var(--dsw-alias-label-primary);cursor:pointer;background:0 0;border:none;border-radius:12px;align-items:center;gap:8px;margin:0 -2px;padding:0 10px 0 8px;font-family:inherit;font-size:14px;display:inline-flex;overflow:hidden}.Mb_bHa_badge:hover,.Mb_bHa_badge[data-active]{background:var(--dsw-alias-interactive-bg-hover)}.Mb_bHa_badgeLabel{text-overflow:ellipsis;white-space:nowrap;min-width:0;overflow:hidden}.Mb_bHa_badgeCount{color:var(--dsw-alias-label-tertiary);font-variant-numeric:tabular-nums;flex:none;margin-left:auto;font-size:12px;line-height:16px}.Mb_bHa_layer.Mb_bHa_rail{width:36px;height:36px;margin:0}.Mb_bHa_rail .Mb_bHa_badge{border-radius:50%;justify-content:center;gap:0;width:36px;height:36px;padding:0}.Mb_bHa_rail .Mb_bHa_footerButtons{flex-direction:column;gap:2px}.Mb_bHa_panel{z-index:30;border:1px solid var(--dsw-alias-border-inverted);background:var(--dsw-specific-menu);width:420px;max-width:calc(100vw - 24px);max-height:60vh;box-shadow:var(--dsw-shadow-lv3);--dsh-scrollbar-thumb:var(--dsw-alias-scrollbar-bg-l2);--dsh-scrollbar-thumb-hover:var(--dsw-alias-scrollbar-hover-l2);border-radius:12px;flex-direction:column;display:flex;position:fixed;overflow:hidden}.Mb_bHa_header{box-sizing:border-box;flex:none;justify-content:space-between;align-items:center;min-height:44px;padding:10px 12px;display:flex}.Mb_bHa_body{flex:1;min-height:0;padding:0 12px 12px;overflow-y:auto}.Mb_bHa_title{color:var(--dsw-alias-label-primary);font-size:14px;font-weight:500;line-height:20px}.Mb_bHa_note,.Mb_bHa_readError{color:var(--dsw-alias-label-tertiary);margin:4px 0;font-size:12px;line-height:18px}.Mb_bHa_readError{color:var(--dsw-alias-state-error-primary)}.Mb_bHa_group{color:var(--dsw-alias-label-caption);text-transform:uppercase;letter-spacing:.04em;margin:8px 0;font-size:11px;font-weight:500;line-height:16px}.Mb_bHa_rows{flex-direction:column;gap:8px;margin:0;padding:0;list-style:none;display:flex}.Mb_bHa_row{border:1px solid var(--dsw-alias-border-l2);border-radius:12px;flex-direction:column;gap:8px;padding:14px 12px 10px;display:flex}.Mb_bHa_row[data-cordis-awaiting]{border-color:var(--dsw-alias-state-business-primary)}.Mb_bHa_rowHead{align-items:center;gap:8px;display:flex}.Mb_bHa_rowId{color:var(--dsw-alias-label-tertiary);font-family:var(--dsh-font-mono,monospace);flex:none;font-size:11px;line-height:20px}.Mb_bHa_rowName{min-width:0;color:var(--dsw-alias-label-primary);text-overflow:ellipsis;white-space:nowrap;flex:1;font-size:13px;font-weight:500;line-height:20px;overflow:hidden}.Mb_bHa_rowStatus{background:var(--dsw-alias-button-ghost-active-fill);height:20px;color:var(--dsw-alias-label-caption);border-radius:10px;flex:none;align-items:center;padding:0 6px;font-size:11px;line-height:20px;display:inline-flex}.Mb_bHa_row[data-cordis-status=idle] .Mb_bHa_rowStatus{background:var(--dsw-alias-button-ghost-active-fill);color:var(--dsw-alias-label-caption)}.Mb_bHa_row[data-cordis-status=awaiting-approval] .Mb_bHa_rowStatus,.Mb_bHa_row[data-cordis-status=client-pending] .Mb_bHa_rowStatus{background:var(--dsw-alias-state-warn-tertiary);color:var(--dsw-alias-state-warn-label)}.Mb_bHa_row[data-cordis-status=failed] .Mb_bHa_rowStatus{background:var(--dsw-alias-interactive-bg-hover-danger);color:var(--dsw-alias-state-error-primary)}.Mb_bHa_row[data-cordis-status=running] .Mb_bHa_rowStatus{background:var(--dsw-alias-state-success-tertiary);color:var(--dsw-alias-state-success-primary)}.Mb_bHa_rowDetail{align-items:center;gap:8px;min-height:28px;display:flex}.Mb_bHa_versionPicker{color:var(--dsw-alias-label-caption);align-items:center;gap:8px;font-size:11px;line-height:18px;display:flex}.Mb_bHa_versionPicker select{border:1px solid var(--dsw-alias-border-l2);min-width:0;height:26px;color:var(--dsw-alias-label-secondary);font:inherit;background:0 0;border-radius:7px;flex:1;padding:0 8px}.Mb_bHa_rowPurpose{min-width:0;color:var(--dsw-alias-label-tertiary);text-overflow:ellipsis;white-space:nowrap;flex:1;font-size:12px;line-height:18px;overflow:hidden}.Mb_bHa_rowError{color:var(--dsw-alias-state-error-primary);font-size:12px;line-height:18px}.Mb_bHa_rowActions{flex:none;align-items:center;gap:10px;display:flex}.Mb_bHa_transition{min-width:0;color:var(--dsw-alias-label-caption);align-items:center;gap:8px;font-size:11px;line-height:18px;display:flex}.Mb_bHa_transitionActions{gap:6px;margin-left:auto;display:flex}.Mb_bHa_transitionActions button{border:1px solid var(--dsw-alias-border-l2);color:var(--dsw-alias-label-secondary);font:inherit;cursor:pointer;background:0 0;border-radius:999px;padding:2px 8px}.Mb_bHa_transitionActions button:hover:not(:disabled){background:var(--dsw-alias-interactive-bg-hover)}.Mb_bHa_transitionActions button:disabled{opacity:.4;cursor:default}.Mb_bHa_activeVersion{color:var(--dsw-alias-label-caption);font-size:11px;line-height:16px}.Mb_bHa_actionButton{width:28px;height:28px;color:var(--dsw-alias-label-tertiary);cursor:pointer;background:0 0;border:none;border-radius:999px;justify-content:center;align-items:center;padding:0;display:inline-flex}.Mb_bHa_actionButton:hover:not(:disabled){background:var(--dsw-alias-interactive-bg-hover);color:var(--dsw-alias-label-secondary)}.Mb_bHa_actionButton:disabled{opacity:.4;cursor:default}.Mb_bHa_doubleCheck{width:17px;height:14px;display:inline-block;position:relative}.Mb_bHa_doubleCheck svg{position:absolute;top:1px}.Mb_bHa_doubleCheck svg:first-child{opacity:.7;left:0}.Mb_bHa_doubleCheck svg:last-child{left:5px}";
		...
		var CordisPanel_module_css_default = {
			"actionButton": "Mb_bHa_actionButton",
			"activeVersion": "Mb_bHa_activeVersion",
			"badge": "Mb_bHa_badge",
			"badgeCount": "Mb_bHa_badgeCount",
			"badgeLabel": "Mb_bHa_badgeLabel",
			"body": "Mb_bHa_body",
			"doubleCheck": "Mb_bHa_doubleCheck",
			"footerButtons": "Mb_bHa_footerButtons",
			"group": "Mb_bHa_group",
			"header": "Mb_bHa_header",
			"layer": "Mb_bHa_layer",
			"note": "Mb_bHa_note",
			"panel": "Mb_bHa_panel",
			"rail": "Mb_bHa_rail",
			"readError": "Mb_bHa_readError",
			"row": "Mb_bHa_row",
			"rowActions": "Mb_bHa_rowActions",
			"rowDetail": "Mb_bHa_rowDetail",
			"rowError": "Mb_bHa_rowError",
			"rowHead": "Mb_bHa_rowHead",
			"rowId": "Mb_bHa_rowId",
			"rowName": "Mb_bHa_rowName",
			"rowPurpose": "Mb_bHa_rowPurpose",
			"rowStatus": "Mb_bHa_rowStatus",
			"rows": "Mb_bHa_rows",
			"title": "Mb_bHa_title",
			"transition": "Mb_bHa_transition",
			"transitionActions": "Mb_bHa_transitionActions",
			"versionPicker": "Mb_bHa_versionPicker"
		};
		//#endregion
