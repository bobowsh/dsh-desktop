window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		//#endregion
		//#region \0dsh-css:/private/tmp/claude-501/-Users-alex-Documents-Code-dataelem-dsh-desktop/8cafdb41-dc87-41ba-bba5-9afd99a08420/scratchpad/harness/packages/client/locale/src/client/LanguageRow.module.css.mjs
		const css = ".MpIfSG_row{border-bottom:1px solid var(--dsw-alias-border-l2);align-items:center;gap:8px;padding:16px 0;display:flex}.MpIfSG_rowText{flex-direction:column;flex:1;gap:4px;min-width:0;padding-right:48px;display:flex}.MpIfSG_title{color:var(--dsw-alias-label-primary);font-size:14px;font-weight:400;line-height:22px}.MpIfSG_selector{background:var(--dsw-alias-bg-module-platform);height:36px;font:inherit;color:var(--dsw-alias-label-primary);cursor:pointer;border:none;border-radius:18px;align-items:center;gap:12px;padding:0 14px;font-size:14px;line-height:22px;display:inline-flex}.MpIfSG_selector:hover{background:var(--dsw-alias-interactive-bg-hover)}.MpIfSG_chevron{flex:none}";
		...
		var LanguageRow_module_css_default = {
			"chevron": "MpIfSG_chevron",
			"row": "MpIfSG_row",
			"rowText": "MpIfSG_rowText",
			"selector": "MpIfSG_selector",
			"title": "MpIfSG_title"
		};
		//#endregion
