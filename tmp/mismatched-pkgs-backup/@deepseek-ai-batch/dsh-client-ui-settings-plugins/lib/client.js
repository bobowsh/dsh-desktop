window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		//#region \0dsh-css:/private/tmp/claude-501/-Users-alex-Documents-Code-dataelem-dsh-desktop/8cafdb41-dc87-41ba-bba5-9afd99a08420/scratchpad/harness/packages/client/ui-settings-plugins/src/client/fields.module.css.mjs
		const css$3 = ".Vpv4UW_field{flex-direction:column;gap:6px;padding:12px 0;display:flex}.Vpv4UW_field+.Vpv4UW_field{border-top:1px solid var(--dsw-alias-border-l2)}.Vpv4UW_head{align-items:center;gap:8px;display:flex}.Vpv4UW_label{min-width:0;color:var(--dsw-alias-label-primary);flex:1;font-size:13px;font-weight:500;line-height:1.5}.Vpv4UW_badges{align-items:center;gap:8px;display:inline-flex}.Vpv4UW_badge{white-space:nowrap;background:var(--dsw-alias-bg-module-platform);color:var(--dsw-alias-label-secondary);border-radius:999px;padding:1px 8px;font-size:11px;font-weight:500;line-height:17px}.Vpv4UW_badgeMuted{white-space:nowrap;color:var(--dsw-alias-label-tertiary);border-radius:999px;padding:1px 8px;font-size:11px;line-height:17px}.Vpv4UW_reset{font:inherit;color:var(--dsw-alias-label-secondary);cursor:pointer;background:0 0;border:none;padding:0;font-size:12px;line-height:1.5}.Vpv4UW_reset:hover:not(:disabled){color:var(--dsw-alias-label-primary)}.Vpv4UW_reset:disabled{cursor:default}.Vpv4UW_input{border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-layer-3);height:34px;font:inherit;color:var(--dsw-alias-label-primary);border-radius:8px;padding:0 12px;font-size:13px;line-height:1.5}.Vpv4UW_input:focus-visible{border-color:var(--dsw-alias-brand-primary);outline:none}.Vpv4UW_input:disabled{color:var(--dsw-alias-label-tertiary);cursor:default}.Vpv4UW_inputInvalid{border-color:var(--dsw-alias-label-error);}.Vpv4UW_invalid{color:var(--dsw-alias-label-error);margin:0;font-size:12px;line-height:1.5}.Vpv4UW_hint{color:var(--dsw-alias-label-tertiary);margin:0;font-size:12px;line-height:1.5}";
		...
		var fields_module_css_default = {
			"badge": "Vpv4UW_badge",
			"badgeMuted": "Vpv4UW_badgeMuted",
			"badges": "Vpv4UW_badges",
			"field": "Vpv4UW_field",
			"head": "Vpv4UW_head",
			"hint": "Vpv4UW_hint",
			"input": "Vpv4UW_input",
			"inputInvalid": "Vpv4UW_inputInvalid",
			"invalid": "Vpv4UW_invalid",
			"label": "Vpv4UW_label",
			"reset": "Vpv4UW_reset"
		};
		//#endregion
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:/private/tmp/claude-501/-Users-alex-Documents-Code-dataelem-dsh-desktop/8cafdb41-dc87-41ba-bba5-9afd99a08420/scratchpad/harness/packages/client/ui-settings-plugins/src/client/PluginCard.module.css.mjs
		const css$2 = "._63M9IG_card{border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-layer-3);border-radius:12px;list-style:none;transition:border-color .16s,background .16s}._63M9IG_card:hover{border-color:var(--dsw-alias-label-dimmed)}._63M9IG_cardOpen{background:var(--dsw-alias-bg-layer-2);border-color:var(--dsw-alias-label-dimmed)}._63M9IG_header{appearance:none;width:100%;font:inherit;color:inherit;text-align:left;cursor:pointer;background:0 0;border:0;border-radius:12px;align-items:center;gap:12px;padding:14px 16px;display:flex}._63M9IG_header:focus-visible{outline:2px solid var(--dsw-alias-brand-primary);outline-offset:-2px}._63M9IG_headText{flex-direction:column;flex:1;gap:4px;min-width:0;display:flex}._63M9IG_name{color:var(--dsw-alias-label-primary);font-size:15px;font-weight:600;line-height:1.4}._63M9IG_description{color:var(--dsw-alias-label-tertiary);font-size:13px;line-height:1.5}._63M9IG_chevron{color:var(--dsw-alias-label-tertiary);flex:none;transition:transform .16s}._63M9IG_chevronOpen{transform:rotate(180deg)}._63M9IG_body{border-top:1px solid var(--dsw-alias-border-l2);margin:0 16px;padding-bottom:8px}._63M9IG_readOnly{color:var(--dsw-alias-label-tertiary);margin:12px 0 0;font-size:12px;line-height:1.5}._63M9IG_pending{white-space:nowrap;background:var(--dsw-alias-bg-module-platform);color:var(--dsw-alias-label-secondary);border-radius:999px;flex:none;padding:1px 8px;font-size:11px;font-weight:500;line-height:17px}._63M9IG_footer{border-top:1px solid var(--dsw-alias-border-l2);justify-content:flex-end;align-items:center;gap:8px;padding:12px 0 4px;display:flex}._63M9IG_failed{min-width:0;color:var(--dsw-alias-label-error);flex:1;margin:0;font-size:12px;line-height:1.5}._63M9IG_discard,._63M9IG_save{appearance:none;font:inherit;cursor:pointer;border:1px solid #0000;border-radius:8px;padding:5px 14px;font-size:13px;line-height:1.5}._63M9IG_discard{border-color:var(--dsw-alias-border-l2);color:var(--dsw-alias-label-secondary);background:0 0}._63M9IG_discard:hover:not(:disabled){color:var(--dsw-alias-label-primary);border-color:var(--dsw-alias-label-dimmed)}._63M9IG_save{background:var(--dsw-alias-label-primary);color:var(--dsw-alias-bg-layer-3)}._63M9IG_discard:disabled,._63M9IG_save:disabled{opacity:.4;cursor:default}._63M9IG_discard:focus-visible,._63M9IG_save:focus-visible{outline:2px solid var(--dsw-alias-brand-primary);outline-offset:1px}";
		...
		var PluginCard_module_css_default = {
			"body": "_63M9IG_body",
			"card": "_63M9IG_card",
			"cardOpen": "_63M9IG_cardOpen",
			"chevron": "_63M9IG_chevron",
			"chevronOpen": "_63M9IG_chevronOpen",
			"description": "_63M9IG_description",
			"discard": "_63M9IG_discard",
			"failed": "_63M9IG_failed",
			"footer": "_63M9IG_footer",
			"headText": "_63M9IG_headText",
			"header": "_63M9IG_header",
			"name": "_63M9IG_name",
			"pending": "_63M9IG_pending",
			"readOnly": "_63M9IG_readOnly",
			"save": "_63M9IG_save"
		};
		//#endregion
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:/private/tmp/claude-501/-Users-alex-Documents-Code-dataelem-dsh-desktop/8cafdb41-dc87-41ba-bba5-9afd99a08420/scratchpad/harness/packages/client/ui-settings-plugins/src/client/PluginsSettingsSection.module.css.mjs
		const css$1 = ".JAqHwW_section{max-width:760px;color:var(--dsw-alias-label-primary);flex-direction:column;gap:12px;display:flex}.JAqHwW_heading{margin:0;font-size:18px;font-weight:600}.JAqHwW_intro{color:var(--dsw-alias-label-tertiary);margin:0;font-size:13px}.JAqHwW_tabs{border-bottom:1px solid var(--dsw-alias-border-l2);align-items:flex-end;gap:22px;margin-top:2px;display:flex}.JAqHwW_tab{color:var(--dsw-alias-label-tertiary);font:inherit;cursor:pointer;background:0 0;border:0;padding:7px 1px 9px;font-size:13px;line-height:20px;position:relative}.JAqHwW_tab:hover,.JAqHwW_tab[data-active=true]{color:var(--dsw-alias-label-primary)}.JAqHwW_tab[data-active=true]:after,.JAqHwW_tab:focus-visible:after{background:var(--dsw-alias-label-primary);content:\"\";border-radius:2px 2px 0 0;height:2px;position:absolute;bottom:-1px;left:0;right:0}.JAqHwW_tab:focus-visible{outline:2px solid var(--dsw-alias-state-business-primary);outline-offset:2px;color:var(--dsw-alias-label-primary);border-radius:2px}.JAqHwW_panel{min-width:0;padding-top:2px}.JAqHwW_cards{flex-direction:column;gap:10px;margin:0;padding:0;list-style:none;display:flex}.JAqHwW_empty{color:var(--dsw-alias-label-tertiary);margin:0;font-size:13px}";
		...
		var PluginsSettingsSection_module_css_default = {
			"cards": "JAqHwW_cards",
			"empty": "JAqHwW_empty",
			"heading": "JAqHwW_heading",
			"intro": "JAqHwW_intro",
			"panel": "JAqHwW_panel",
			"section": "JAqHwW_section",
			"tab": "JAqHwW_tab",
			"tabs": "JAqHwW_tabs"
		};
		//#endregion
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:/private/tmp/claude-501/-Users-alex-Documents-Code-dataelem-dsh-desktop/8cafdb41-dc87-41ba-bba5-9afd99a08420/scratchpad/harness/packages/client/ui-settings-plugins/src/client/SubagentModelSelectionCard.module.css.mjs
		const css = ".p_p5hG_permission{gap:6px;padding:12px 0;display:grid}.p_p5hG_toggleRow{color:var(--dsw-alias-label-secondary);justify-content:space-between;align-items:flex-start;gap:16px;font-size:13px;line-height:1.5;display:flex}.p_p5hG_toggleLabel{flex:1;min-width:0}.p_p5hG_switch{box-sizing:border-box;background:var(--dsw-alias-border-l3);cursor:pointer;border:0;border-radius:10px;flex:none;width:36px;height:20px;padding:2px;position:relative}.p_p5hG_switchOn{background:var(--dsw-alias-brand-primary)}.p_p5hG_switch:disabled{cursor:default;opacity:.5}.p_p5hG_switch:focus-visible{outline:2px solid var(--dsw-alias-brand-primary);outline-offset:2px}.p_p5hG_thumb{background:var(--dsw-alias-label-primary-foreground);border-radius:50%;width:16px;height:16px;transition:transform .12s;display:block}.p_p5hG_switchOn .p_p5hG_thumb{transform:translate(16px)}.p_p5hG_selection{gap:10px;display:grid}.p_p5hG_hint,.p_p5hG_notice,.p_p5hG_invalid,.p_p5hG_conflict{margin:0;font-size:12px;line-height:1.5}.p_p5hG_hint,.p_p5hG_notice{color:var(--dsw-alias-label-tertiary)}.p_p5hG_invalid,.p_p5hG_conflict{color:var(--dsw-alias-label-error)}.p_p5hG_catalogError{color:var(--dsw-alias-label-error);justify-content:space-between;align-items:center;gap:12px;font-size:12px;display:flex}.p_p5hG_catalogError button{color:var(--dsw-alias-brand-primary);cursor:pointer;background:0 0;border:0;padding:0}.p_p5hG_models{border:1px solid var(--dsw-alias-border-l2);border-radius:8px;gap:6px;min-width:0;max-height:280px;margin:0;padding:10px;display:grid;overflow:auto}.p_p5hG_models legend{color:var(--dsw-alias-label-secondary);padding:0 4px;font-size:12px}.p_p5hG_modelGroup{gap:6px;display:grid}.p_p5hG_modelGroup+.p_p5hG_modelGroup{border-top:1px solid var(--dsw-alias-border-l3);margin-top:4px;padding-top:10px}.p_p5hG_providerName{color:var(--dsw-alias-label-tertiary);padding:0 6px;font-size:11px;font-weight:500}.p_p5hG_model{cursor:pointer;border-radius:6px;grid-template-columns:auto minmax(0,1fr) auto;align-items:center;gap:8px;min-width:0;padding:6px;display:grid}.p_p5hG_model:hover{background:var(--dsw-alias-bg-layer-4)}.p_p5hG_modelName,.p_p5hG_route{text-overflow:ellipsis;white-space:nowrap;display:block;overflow:hidden}.p_p5hG_modelName{color:var(--dsw-alias-label-primary);font-size:13px}.p_p5hG_route{color:var(--dsw-alias-label-tertiary);margin-top:2px;font-size:11px}.p_p5hG_unavailable{color:var(--dsw-alias-label-tertiary);font-size:11px}";
		...
		var SubagentModelSelectionCard_module_css_default = {
			"catalogError": "p_p5hG_catalogError",
			"conflict": "p_p5hG_conflict",
			"hint": "p_p5hG_hint",
			"invalid": "p_p5hG_invalid",
			"model": "p_p5hG_model",
			"modelGroup": "p_p5hG_modelGroup",
			"modelName": "p_p5hG_modelName",
			"models": "p_p5hG_models",
			"notice": "p_p5hG_notice",
			"permission": "p_p5hG_permission",
			"providerName": "p_p5hG_providerName",
			"route": "p_p5hG_route",
			"selection": "p_p5hG_selection",
			"switch": "p_p5hG_switch",
			"switchOn": "p_p5hG_switchOn",
			"thumb": "p_p5hG_thumb",
			"toggleLabel": "p_p5hG_toggleLabel",
			"toggleRow": "p_p5hG_toggleRow",
			"unavailable": "p_p5hG_unavailable"
		};
		//#endregion
