window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		//#region \0dsh-css:/private/tmp/claude-501/-Users-alex-Documents-Code-dataelem-dsh-desktop/8cafdb41-dc87-41ba-bba5-9afd99a08420/scratchpad/harness/packages/client/ui-jobs/src/client/JobListAction.module.css.mjs
		const css = ".J2gA0a_root{position:relative}.J2gA0a_trigger{min-height:28px;color:var(--dsw-alias-label-tertiary);cursor:pointer;background:0 0;border:0;border-radius:6px;align-items:center;gap:3px;padding:3px 2px;font-size:12px;line-height:18px;display:inline-flex}.J2gA0a_trigger:hover,.J2gA0a_trigger:focus-visible{color:var(--dsw-alias-label-secondary)}.J2gA0a_trigger svg{transition:transform .12s}.J2gA0a_triggerOpen{transform:rotate(180deg)}.J2gA0a_triggerDot{flex:none}.J2gA0a_count{margin:0 5px}.J2gA0a_menu{z-index:100;box-sizing:border-box;border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-specific-menu);--dsh-scrollbar-thumb:var(--dsw-alias-scrollbar-bg-l2);--dsh-scrollbar-thumb-hover:var(--dsw-alias-scrollbar-hover-l2);width:336px;max-width:min(400px,100vw - 32px);max-height:min(420px,100vh - 140px);box-shadow:var(--dsw-shadow-lv3);border-radius:12px;flex-direction:column;gap:1px;margin:0;padding:4px;list-style:none;display:flex;position:absolute;top:calc(100% + 5px);left:0;overflow:auto}.J2gA0a_row{box-sizing:border-box;width:100%;min-height:32px;color:var(--dsw-alias-label-primary);border-radius:8px;align-items:center;gap:8px;padding:6px 8px;font-size:13px;line-height:18px;display:flex}.J2gA0a_rowSettled{color:var(--dsw-alias-label-tertiary)}.J2gA0a_rowDot{flex:none}.J2gA0a_kind{background:var(--dsw-alias-fill-l2);color:var(--dsw-alias-label-secondary);border-radius:5px;flex:none;padding:0 6px;font-size:11px;line-height:18px}.J2gA0a_label{min-width:0;font-family:var(--dsw-font-mono);white-space:nowrap;text-overflow:ellipsis;flex:1;overflow:hidden}.J2gA0a_status,.J2gA0a_duration{color:var(--dsw-alias-label-tertiary);flex:none;font-size:11px;line-height:18px}.J2gA0a_status{white-space:nowrap;text-overflow:ellipsis;max-width:40%;overflow:hidden}.J2gA0a_duration{font-variant-numeric:tabular-nums}";
		...
		var JobListAction_module_css_default = {
			"count": "J2gA0a_count",
			"duration": "J2gA0a_duration",
			"kind": "J2gA0a_kind",
			"label": "J2gA0a_label",
			"menu": "J2gA0a_menu",
			"root": "J2gA0a_root",
			"row": "J2gA0a_row",
			"rowDot": "J2gA0a_rowDot",
			"rowSettled": "J2gA0a_rowSettled",
			"status": "J2gA0a_status",
			"trigger": "J2gA0a_trigger",
			"triggerDot": "J2gA0a_triggerDot",
			"triggerOpen": "J2gA0a_triggerOpen"
		};
		//#endregion
