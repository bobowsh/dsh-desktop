window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:/private/tmp/claude-501/-Users-alex-Documents-Code-dataelem-dsh-desktop/8cafdb41-dc87-41ba-bba5-9afd99a08420/scratchpad/harness/packages/client/ui-layout/src/client/AppFrame.module.css.mjs
		const css = ".m45BUG_frame{background:var(--dsw-alias-bg-base);height:100%;transition:grid-template-columns var(--ds-transition-duration-slow) var(--ds-ease-in-out);grid-template-rows:100%;display:grid;position:relative;overflow:hidden}.m45BUG_frame[data-dragging]{transition:none}@media (prefers-reduced-motion:reduce){.m45BUG_frame{transition:none}}.m45BUG_sidebarCol{background:var(--dsw-specific-sidebar-fill);border-right:1px solid var(--dsw-alias-border-l1);min-width:0;overflow:hidden}.m45BUG_centerCol{flex-direction:column;min-width:0;display:flex;overflow:hidden}.m45BUG_detailsCol{border-left:1px solid var(--dsw-alias-border-l2);min-width:0;overflow:hidden}.m45BUG_frame[data-details-collapsed] .m45BUG_detailsCol{border-left:none}.m45BUG_handle{cursor:col-resize;z-index:2;touch-action:none;width:8px;transition:left var(--ds-transition-duration-slow) var(--ds-ease-in-out);margin-left:-4px;position:absolute;top:0;bottom:0}.m45BUG_frame[data-dragging] .m45BUG_handle{transition:none}@media (prefers-reduced-motion:reduce){.m45BUG_handle{transition:none}}.m45BUG_handle[data-side=details]:after{content:\"\";box-sizing:border-box;background:var(--dsw-alias-button-floating-fill);border:1px solid var(--dsw-alias-border-l2-darkmode-thin);opacity:0;width:12px;height:32px;transition:opacity var(--ds-transition-duration-slow) var(--ds-ease-in-out), background var(--ds-transition-duration-slow) var(--ds-ease-in-out);border-radius:10px;position:absolute;top:50%;left:50%;transform:translate(-50%,-50%)}.m45BUG_detailsCol:hover~.m45BUG_handle[data-side=details]:after,.m45BUG_handle[data-side=details]:hover:after,.m45BUG_handle[data-side=details][data-dragging=true]:after{opacity:1}.m45BUG_handle[data-side=details]:hover:after,.m45BUG_handle[data-side=details][data-dragging=true]:after{background:var(--dsw-alias-button-floating-hover);border-color:var(--dsw-alias-border-l3)}.m45BUG_overlayLayer{z-index:20;pointer-events:none;position:absolute;inset:0}.m45BUG_overlayLayer>*{pointer-events:auto}";
		...
		var AppFrame_module_css_default = {
			"centerCol": "m45BUG_centerCol",
			"detailsCol": "m45BUG_detailsCol",
			"frame": "m45BUG_frame",
			"handle": "m45BUG_handle",
			"overlayLayer": "m45BUG_overlayLayer",
			"sidebarCol": "m45BUG_sidebarCol"
		};
		//#endregion
