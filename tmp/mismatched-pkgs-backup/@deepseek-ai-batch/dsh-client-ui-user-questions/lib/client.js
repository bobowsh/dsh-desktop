window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:/private/tmp/claude-501/-Users-alex-Documents-Code-dataelem-dsh-desktop/8cafdb41-dc87-41ba-bba5-9afd99a08420/scratchpad/harness/packages/client/ui-user-questions/src/client/PlanReviewPanel.module.css.mjs
		const css$1 = ".Q2Mq-W_frame{padding:6px calc(var(--dsh-composer-side-clearance) + 16px) 10px;justify-content:center;display:flex}.Q2Mq-W_card{width:100%;max-width:var(--dsh-chat-content-width);border:1px solid var(--dsw-alias-state-warn-secondary);background:var(--dsw-specific-input-major);max-height:min(60vh,520px);box-shadow:var(--dsw-shadow-lv2);color:var(--dsw-alias-label-primary);--dsh-scrollbar-thumb:var(--dsw-alias-scrollbar-bg-l2);--dsh-scrollbar-thumb-hover:var(--dsw-alias-scrollbar-hover-l2);border-radius:20px;flex-direction:column;display:flex;overflow:hidden}.Q2Mq-W_card,.Q2Mq-W_card *{box-sizing:border-box}.Q2Mq-W_strip{background:var(--dsw-alias-state-warn-tertiary);color:var(--dsw-alias-state-warn-primary);flex-shrink:0;align-items:center;gap:8px;padding:10px 16px;font-size:13px;line-height:18px;display:flex}.Q2Mq-W_dot{background:var(--dsw-alias-state-warn-primary);border-radius:50%;width:8px;height:8px}.Q2Mq-W_body{overscroll-behavior:contain;flex:auto;min-height:0;padding:12px 16px 4px;font-size:14px;line-height:22px;overflow-y:auto}.Q2Mq-W_footer{flex-shrink:0;justify-content:space-between;align-items:center;gap:12px;padding:8px 16px 12px;display:flex}.Q2Mq-W_feedback{min-height:16px;color:var(--dsw-alias-state-error-primary);font-size:11px;line-height:16px}.Q2Mq-W_actions{flex-shrink:0;align-items:center;gap:8px;display:flex}.Q2Mq-W_discuss{color:var(--dsw-alias-label-secondary);gap:6px}.Q2Mq-W_discuss:hover:not(:disabled){color:var(--dsw-alias-label-primary)}@media (width<=720px){.Q2Mq-W_card{border-radius:16px}.Q2Mq-W_body{padding:10px 12px 4px}.Q2Mq-W_footer{align-items:flex-end;padding:8px 12px 10px}}";
		...
		var PlanReviewPanel_module_css_default = {
			"actions": "Q2Mq-W_actions",
			"body": "Q2Mq-W_body",
			"card": "Q2Mq-W_card",
			"discuss": "Q2Mq-W_discuss",
			"dot": "Q2Mq-W_dot",
			"feedback": "Q2Mq-W_feedback",
			"footer": "Q2Mq-W_footer",
			"frame": "Q2Mq-W_frame",
			"strip": "Q2Mq-W_strip"
		};
		//#endregion
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:/private/tmp/claude-501/-Users-alex-Documents-Code-dataelem-dsh-desktop/8cafdb41-dc87-41ba-bba5-9afd99a08420/scratchpad/harness/packages/client/ui-user-questions/src/client/QuestionComposer.module.css.mjs
		const css = ".eAi83q_frame{padding:6px calc(var(--dsh-composer-side-clearance) + 16px) 10px;justify-content:center;display:flex}.eAi83q_card{width:100%;max-width:var(--dsh-chat-content-width);border:1px solid var(--dsw-alias-border-l2-darkmode-thin);background:var(--dsw-specific-input-major);max-height:min(60vh,520px);box-shadow:var(--dsw-shadow-lv2);color:var(--dsw-alias-label-primary);--dsh-scrollbar-thumb:var(--dsw-alias-scrollbar-bg-l2);--dsh-scrollbar-thumb-hover:var(--dsw-alias-scrollbar-hover-l2);border-radius:20px;flex-direction:column;padding:0 0 10px;display:flex;overflow:hidden}.eAi83q_card,.eAi83q_card *{box-sizing:border-box}.eAi83q_cardMinimized{max-height:none}.eAi83q_cardMinimized .eAi83q_header{padding-bottom:14px}.eAi83q_headerActions{flex-shrink:0;align-items:center;gap:4px;display:flex}.eAi83q_header{flex-shrink:0;justify-content:space-between;align-items:flex-start;gap:16px;padding:20px 16px 0 24px;display:flex}.eAi83q_headingBlock{min-width:0}.eAi83q_eyebrow{color:var(--dsw-alias-label-tertiary);margin-bottom:5px;font-size:11px;line-height:16px}.eAi83q_title{margin:0;font-size:16px;font-weight:500;line-height:22px}.eAi83q_detail{margin:0 2px 8px}.eAi83q_footerActions{flex-shrink:0;align-items:center;gap:12px;display:flex}.eAi83q_pager{flex-shrink:0;align-items:center;gap:6px;display:flex}.eAi83q_progress{color:var(--dsw-alias-label-secondary);white-space:nowrap;word-spacing:-2px;padding:0 4px;font-size:14px;font-weight:500;line-height:24px}.eAi83q_iconButton{width:24px;height:24px;color:var(--dsw-alias-label-tertiary);cursor:pointer;background:0 0;border:none;border-radius:999px;place-items:center;padding:0;display:grid}.eAi83q_iconButton:hover:not(:disabled){background:var(--dsw-alias-interactive-bg-hover);color:var(--dsw-alias-label-primary)}.eAi83q_iconButton:disabled{color:var(--dsw-alias-label-dimmed);cursor:default}.eAi83q_body{overscroll-behavior:contain;flex-direction:column;flex:auto;min-height:0;display:flex;overflow-y:auto}.eAi83q_options{flex-direction:column;gap:1px;margin:8px 0 0;padding:4px 12px;display:flex}.eAi83q_option{width:100%;min-height:40px;color:inherit;text-align:left;cursor:pointer;background:0 0;border:1px solid #0000;border-radius:12px;flex-shrink:0;align-items:flex-start;gap:8px;padding:8px 12px 8px 8px;transition:background-color .12s,border-color .12s;display:flex}.eAi83q_option:hover:not(:disabled),.eAi83q_optionSelected{background:var(--dsw-alias-interactive-bg-hover)}.eAi83q_optionSelected{border-color:var(--dsw-alias-border-l2)}.eAi83q_option:disabled{cursor:default}.eAi83q_number{background:var(--dsw-alias-bg-overlay);width:20px;height:20px;color:var(--dsw-alias-label-secondary);border-radius:6px;flex:0 0 20px;place-items:center;margin-top:2px;font-size:12px;font-weight:500;line-height:18px;display:grid}.eAi83q_checkbox{flex:0 0 20px;place-items:center;width:20px;height:20px;margin-top:2px;display:grid}.eAi83q_checkbox:before{content:\"\";border:1px solid var(--dsw-alias-border-l4);border-radius:4px;grid-area:1/1;width:14px;height:14px;transition:background-color .12s,border-color .12s}.eAi83q_checkbox>svg{grid-area:1/1}.eAi83q_checkboxChecked{color:var(--dsw-alias-label-primary-foreground)}.eAi83q_checkboxChecked:before{border-color:var(--dsw-alias-label-primary);background:var(--dsw-alias-label-primary)}.eAi83q_optionCopy{flex:1;min-width:0}.eAi83q_optionLine{flex-wrap:wrap;align-items:baseline;gap:2px 6px;display:flex}.eAi83q_optionLabel{font-size:14px;font-weight:500;line-height:24px}.eAi83q_badge{background:var(--dsw-specific-sidebar-nav-item-active-accent);color:var(--dsw-alias-button-info-fill);border-radius:6px;padding:0 4px;font-size:11px;font-weight:600;line-height:18px}.eAi83q_description{color:var(--dsw-alias-label-tertiary);font-size:14px;font-weight:400;line-height:24px}.eAi83q_customRow{border:1px solid #0000;border-radius:12px;flex-shrink:0;align-items:flex-start;gap:8px;width:100%;min-height:40px;padding:8px 12px 8px 8px;transition:background-color .12s,border-color .12s;display:flex}.eAi83q_customRow:hover,.eAi83q_customRow:focus-within,.eAi83q_customRowActive{background:var(--dsw-alias-interactive-bg-hover)}.eAi83q_customRow:focus-within,.eAi83q_customRowActive{border-color:var(--dsw-alias-border-l2)}.eAi83q_field{--dsh-answer-field-padding:0;min-width:0;display:grid}.eAi83q_field>*{min-width:0;padding:var(--dsh-answer-field-padding);font:inherit;white-space:pre-wrap;word-break:break-word;overflow-wrap:anywhere;grid-area:1/1;font-size:14px;line-height:24px}.eAi83q_fieldMirror{box-sizing:content-box;visibility:hidden;max-height:144px;overflow:hidden}.eAi83q_fieldInput{resize:none;color:var(--dsw-alias-label-primary);caret-color:var(--dsw-alias-state-business-primary);background:0 0;border:none;outline:none;overflow-y:auto}.eAi83q_fieldInput::placeholder{color:var(--dsw-alias-label-caption)}.eAi83q_customInline{flex:1}.eAi83q_customBlock{border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-module-platform);--dsh-answer-field-padding:8px 12px;border-radius:10px;flex-shrink:0;min-height:64px;margin:0 12px}.eAi83q_customBlock:focus-within{border-color:var(--dsw-alias-state-business-primary)}.eAi83q_footer{flex-shrink:0;justify-content:space-between;align-items:center;gap:12px;margin-top:12px;padding:0 10px 0 18px;display:flex}.eAi83q_feedback{min-height:16px;color:var(--dsw-alias-state-error-primary);text-align:right;flex:1;font-size:11px;line-height:16px}@media (width<=720px){.eAi83q_card{border-radius:16px}.eAi83q_header{padding:10px 12px 0 18px}.eAi83q_options{padding:4px 8px}.eAi83q_title{font-size:15px;line-height:21px}.eAi83q_option,.eAi83q_customRow{padding:8px 6px}.eAi83q_footer{align-items:flex-end;padding:0 10px}.eAi83q_footerActions{flex-shrink:0}}@media (prefers-reduced-motion:reduce){.eAi83q_option,.eAi83q_customRow{transition:none}}";
		...
		var QuestionComposer_module_css_default = {
			...
			"body": "eAi83q_body",
			"card": "eAi83q_card",
			"cardMinimized": "eAi83q_cardMinimized",
			"checkbox": "eAi83q_checkbox",
			"checkboxChecked": "eAi83q_checkboxChecked",
			"customBlock": "eAi83q_customBlock",
			"customInline": "eAi83q_customInline",
			"customRow": "eAi83q_customRow",
			"customRowActive": "eAi83q_customRowActive",
			"description": "eAi83q_description",
			"detail": "eAi83q_detail",
			"eyebrow": "eAi83q_eyebrow",
			"feedback": "eAi83q_feedback",
			"field": "eAi83q_field",
			"fieldInput": "eAi83q_fieldInput",
			"fieldMirror": "eAi83q_fieldMirror",
			"footer": "eAi83q_footer",
			"footerActions": "eAi83q_footerActions",
			"frame": "eAi83q_frame",
			"header": "eAi83q_header",
			"headerActions": "eAi83q_headerActions",
			"headingBlock": "eAi83q_headingBlock",
			"iconButton": "eAi83q_iconButton",
			"number": "eAi83q_number",
			"option": "eAi83q_option",
			"optionCopy": "eAi83q_optionCopy",
			"optionLabel": "eAi83q_optionLabel",
			"optionLine": "eAi83q_optionLine",
			"optionSelected": "eAi83q_optionSelected",
			"options": "eAi83q_options",
			"pager": "eAi83q_pager",
			"progress": "eAi83q_progress",
			"title": "eAi83q_title"
		};
		//#endregion
