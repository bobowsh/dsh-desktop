window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		//#region \0dsh-css:/private/tmp/claude-501/-Users-alex-Documents-Code-dataelem-dsh-desktop/8cafdb41-dc87-41ba-bba5-9afd99a08420/scratchpad/harness/packages/client/ui-subagent/src/client/SubagentHeaderLineage.module.css.mjs
		const css$1 = ".dSpGsa_root{align-items:center;gap:10px;min-width:0;display:inline-flex;position:relative}.dSpGsa_switcherRoot{min-width:0;margin-left:6px}.dSpGsa_trigger,.dSpGsa_switcherTrigger{min-height:28px;color:var(--dsw-alias-label-tertiary);cursor:pointer;background:0 0;border:0;border-radius:6px;align-items:center;padding:3px 2px;font-size:12px;line-height:18px;display:inline-flex}.dSpGsa_trigger{gap:4px}.dSpGsa_switcherTrigger{min-width:0;max-width:244px;color:var(--dsw-alias-label-primary);gap:4px;font-weight:500}.dSpGsa_ancestorSwitcherTrigger{color:var(--dsw-alias-label-tertiary);font-weight:400}.dSpGsa_switcherTitle{text-overflow:ellipsis;white-space:nowrap;flex:1;min-width:0;overflow:hidden}.dSpGsa_switcherTrigger svg{flex:none}.dSpGsa_separator{color:var(--dsw-alias-label-caption);font-size:14px;line-height:20px}.dSpGsa_activitySlot{flex:none;width:10px;height:10px;display:inline-flex}.dSpGsa_trigger:hover,.dSpGsa_trigger:focus-visible{color:var(--dsw-alias-label-secondary)}.dSpGsa_switcherTrigger:hover,.dSpGsa_switcherTrigger:focus-visible{color:var(--dsw-alias-label-primary)}.dSpGsa_ancestorSwitcherTrigger:hover,.dSpGsa_ancestorSwitcherTrigger:focus-visible{color:var(--dsw-alias-label-tertiary)}.dSpGsa_trigger svg,.dSpGsa_switcherTrigger svg{transition:transform .12s}.dSpGsa_triggerOpen{transform:rotate(180deg)}.dSpGsa_menu{z-index:100;box-sizing:border-box;background:var(--dsw-specific-menu);--dsh-scrollbar-thumb:var(--dsw-alias-scrollbar-bg-l2);--dsh-scrollbar-thumb-hover:var(--dsw-alias-scrollbar-hover-l2);width:336px;max-width:min(400px,100vw - 32px);max-height:min(560px,100vh - 140px);box-shadow:var(--dsw-shadow-lv3);border-radius:12px;flex-direction:column;padding:4px;display:flex;position:fixed;overflow:auto}.dSpGsa_node{min-width:0;position:relative}.dSpGsa_menu>.dSpGsa_node{margin-left:-3px}.dSpGsa_row{box-sizing:border-box;width:100%;min-height:50px;color:var(--dsw-alias-label-primary);text-align:left;cursor:pointer;background:0 0;border:0;border-radius:8px;outline:none;align-items:flex-start;gap:8px;padding:7px 8px 7px 11px;font-size:13px;line-height:18px;display:flex;position:relative}.dSpGsa_row:hover>.dSpGsa_clickarea,.dSpGsa_row:focus-visible>.dSpGsa_clickarea{background:var(--dsw-alias-interactive-bg-hover)}.dSpGsa_clickarea{box-sizing:border-box;border-radius:8px;flex:1;align-self:stretch;align-items:flex-start;gap:8px;min-width:0;margin:-7px -8px;padding:7px 8px;display:flex}.dSpGsa_row>[data-state],.dSpGsa_clickarea>[data-state]{margin-top:4px}.dSpGsa_disabled{color:var(--dsw-alias-label-dimmed);cursor:not-allowed}.dSpGsa_disabled:hover{background:0 0}.dSpGsa_loadingRow{cursor:default}.dSpGsa_disclosure,.dSpGsa_disclosureSpace{flex:none;width:14px;height:18px}.dSpGsa_disclosure{color:var(--dsw-alias-label-tertiary);cursor:pointer;background:0 0;border:0;justify-content:center;align-items:center;padding:0;transition:transform .12s;display:inline-flex}.dSpGsa_disclosure:hover{color:var(--dsw-alias-label-primary)}.dSpGsa_disclosureOpen{transform:rotate(90deg)}.dSpGsa_content{flex-direction:column;flex:1;min-width:0;display:flex}.dSpGsa_label,.dSpGsa_summary{text-overflow:ellipsis;white-space:nowrap;overflow:hidden}.dSpGsa_label{color:inherit;font-weight:400}.dSpGsa_currentLabel{font-weight:600}.dSpGsa_summary,.dSpGsa_metrics{color:var(--dsw-alias-label-tertiary);font-size:11px;line-height:16px}.dSpGsa_metrics{font-variant-numeric:tabular-nums;text-align:right;white-space:nowrap;flex:none;grid-template-rows:18px 16px;display:grid}.dSpGsa_metricToken{grid-row:1;line-height:18px}.dSpGsa_metricDuration{grid-row:2}.dSpGsa_children{margin-left:18px;padding-left:4px;position:relative}.dSpGsa_children:before,.dSpGsa_children>.dSpGsa_node:before{content:\"\";border-left:1px solid var(--dsw-alias-border-l2);position:absolute;left:0}.dSpGsa_children:before{height:26px;top:-26px}.dSpGsa_children[aria-busy=true]:before{content:none}.dSpGsa_children>.dSpGsa_node:before{top:0;bottom:0;left:-4px}.dSpGsa_children>.dSpGsa_node:last-child:before{height:17px;bottom:auto}.dSpGsa_children>.dSpGsa_node>.dSpGsa_row:before{content:\"\";border-top:1px solid var(--dsw-alias-border-l2);width:14px;position:absolute;top:16px;left:-4px}.dSpGsa_notice,.dSpGsa_error{color:var(--dsw-alias-label-tertiary);padding:10px 12px;font-size:12px;line-height:18px}.dSpGsa_error{color:var(--dsw-alias-state-error-primary);justify-content:space-between;align-items:center;gap:12px;display:flex}.dSpGsa_refresh{color:inherit;cursor:pointer;background:0 0;border:0;border-radius:6px;flex:none;align-items:center;gap:4px;padding:4px 6px;display:inline-flex}.dSpGsa_refresh:hover{background:var(--dsw-alias-interactive-bg-hover)}";
		...
		var SubagentHeaderLineage_module_css_default = {
			"activitySlot": "dSpGsa_activitySlot",
			"ancestorSwitcherTrigger": "dSpGsa_ancestorSwitcherTrigger",
			"children": "dSpGsa_children",
			"clickarea": "dSpGsa_clickarea",
			"content": "dSpGsa_content",
			"currentLabel": "dSpGsa_currentLabel",
			"disabled": "dSpGsa_disabled",
			"disclosure": "dSpGsa_disclosure",
			"disclosureOpen": "dSpGsa_disclosureOpen",
			"disclosureSpace": "dSpGsa_disclosureSpace",
			"error": "dSpGsa_error",
			"label": "dSpGsa_label",
			"loadingRow": "dSpGsa_loadingRow",
			"menu": "dSpGsa_menu",
			"metricDuration": "dSpGsa_metricDuration",
			"metricToken": "dSpGsa_metricToken",
			"metrics": "dSpGsa_metrics",
			"node": "dSpGsa_node",
			"notice": "dSpGsa_notice",
			"refresh": "dSpGsa_refresh",
			"root": "dSpGsa_root",
			"row": "dSpGsa_row",
			"separator": "dSpGsa_separator",
			"summary": "dSpGsa_summary",
			"switcherRoot": "dSpGsa_switcherRoot",
			"switcherTitle": "dSpGsa_switcherTitle",
			"switcherTrigger": "dSpGsa_switcherTrigger",
			"trigger": "dSpGsa_trigger",
			"triggerOpen": "dSpGsa_triggerOpen"
		};
		//#endregion
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:/private/tmp/claude-501/-Users-alex-Documents-Code-dataelem-dsh-desktop/8cafdb41-dc87-41ba-bba5-9afd99a08420/scratchpad/harness/packages/client/ui-subagent/src/client/SubagentReadOnlyComposer.module.css.mjs
		const css = ".x6JNyW_frame{border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-layer-1);min-height:54px;color:var(--dsw-alias-label-tertiary);border-radius:14px;justify-content:center;align-items:center;gap:8px;margin:0 24px 20px;padding:10px 16px;font-size:13px;line-height:20px;display:flex}.x6JNyW_frame strong{color:var(--dsw-alias-label-primary);font-weight:510}";
		...
		var SubagentReadOnlyComposer_module_css_default = { "frame": "x6JNyW_frame" };
		//#endregion
