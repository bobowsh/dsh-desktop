window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:/private/tmp/claude-501/-Users-alex-Documents-Code-dataelem-dsh-desktop/8cafdb41-dc87-41ba-bba5-9afd99a08420/scratchpad/harness/packages/client/ui-tool/src/client/tool/components/AskQuestionCard.module.css.mjs
		const css$4 = ".sKgtiW_card{border:1px solid var(--dsw-alias-border-l1);background:var(--dsw-alias-bg-base);border-radius:12px;flex-direction:column;gap:16px;max-height:360px;margin:4px 0 4px 4px;padding:16px 20px;display:flex;overflow-y:auto}.sKgtiW_item{flex-direction:column;gap:2px;min-width:0;display:flex}.sKgtiW_question,.sKgtiW_answer{white-space:pre-wrap;overflow-wrap:anywhere;font-size:var(--dsh-content-font-size,14px);line-height:calc(24px + var(--dsh-content-font-delta,0px));margin:0}.sKgtiW_question{color:var(--dsw-alias-label-tertiary)}.sKgtiW_answer{color:var(--dsw-alias-label-primary)}.sKgtiW_answerLine{display:block}.sKgtiW_skipped{color:var(--dsw-alias-label-tertiary)}.sKgtiW_verdict{color:var(--dsw-alias-label-primary);font-size:var(--dsh-content-font-size,14px);line-height:calc(24px + var(--dsh-content-font-delta,0px));margin:0}.sKgtiW_questionList{flex-direction:column;gap:8px;margin:0;padding-left:20px;display:flex}.sKgtiW_unansweredQuestion{color:var(--dsw-alias-label-tertiary);white-space:pre-wrap;overflow-wrap:anywhere;font-size:var(--dsh-content-font-size,14px);line-height:calc(24px + var(--dsh-content-font-delta,0px))}";
		...
		var AskQuestionCard_module_css_default = {
			"answer": "sKgtiW_answer",
			"answerLine": "sKgtiW_answerLine",
			"card": "sKgtiW_card",
			"item": "sKgtiW_item",
			"question": "sKgtiW_question",
			"questionList": "sKgtiW_questionList",
			"skipped": "sKgtiW_skipped",
			"unansweredQuestion": "sKgtiW_unansweredQuestion",
			"verdict": "sKgtiW_verdict"
		};
		//#endregion
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:/private/tmp/claude-501/-Users-alex-Documents-Code-dataelem-dsh-desktop/8cafdb41-dc87-41ba-bba5-9afd99a08420/scratchpad/harness/packages/client/ui-tool/src/client/tool/components/ToolRow.module.css.mjs
		const css$3 = ".e-Ux-W_root{flex-direction:column;display:flex}.e-Ux-W_row{position:relative;overflow:hidden}.e-Ux-W_root[data-state=running] .e-Ux-W_row:after{content:\"\";background:linear-gradient(90deg, transparent 0%, color-mix(in srgb, var(--dsw-alias-bg-base) 60%, transparent) 55%, transparent 100%);pointer-events:none;width:300px;animation:2.6s ease-out infinite e-Ux-W_dsh-tool-row-sweep;position:absolute;top:0;bottom:0;left:0}@keyframes e-Ux-W_dsh-tool-row-sweep{0%{left:-300px}90%,to{left:100%}}.e-Ux-W_leading{flex-shrink:0}.e-Ux-W_root[data-tool^=cordis_] .e-Ux-W_leading,.e-Ux-W_root[data-tool^=cordis_] .e-Ux-W_title{color:var(--dsw-alias-state-business-primary)}.e-Ux-W_root[data-tool^=cordis_] .e-Ux-W_title{font-weight:500}.e-Ux-W_root[data-tool^=cordis_] .e-Ux-W_sep{background:var(--dsw-alias-state-business-primary)}.e-Ux-W_chevron{color:var(--dsw-alias-label-secondary)}.e-Ux-W_title{font-weight:400}.e-Ux-W_sep{background:var(--dsw-alias-label-caption);border-radius:1px;flex:none;width:2px;height:2px;margin:0 8px}.e-Ux-W_summary{text-overflow:ellipsis;white-space:nowrap;min-width:0;font-size:var(--dsh-content-font-size-secondary,13px);line-height:calc(24px + var(--dsh-content-font-delta,0px));color:var(--dsw-alias-label-tertiary);flex:auto;overflow:hidden}.e-Ux-W_summarySuffix{white-space:nowrap;font-size:var(--dsh-content-font-size-secondary,13px);line-height:calc(24px + var(--dsh-content-font-delta,0px));color:var(--dsw-alias-label-tertiary);flex:none;margin-left:4px}.e-Ux-W_fileLink{text-overflow:ellipsis;white-space:nowrap;min-width:0;font:inherit;text-align:left;font-size:var(--dsh-content-font-size-secondary,13px);line-height:calc(24px + var(--dsh-content-font-delta,0px));color:var(--dsw-alias-label-secondary);text-decoration:underline;text-decoration-color:var(--dsw-alias-label-quaternary);text-underline-offset:3px;cursor:pointer;background:0 0;border:none;flex:auto;margin:0;padding:0;overflow:hidden}.e-Ux-W_fileLink:hover{color:var(--dsw-alias-label-primary);text-decoration-color:currentColor}.e-Ux-W_errorSummary{color:var(--dsw-alias-state-error-primary)}.e-Ux-W_bodyWrap{flex-direction:column;display:flex}.e-Ux-W_inspectButton{border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-base);color:var(--dsw-alias-label-secondary);cursor:pointer;opacity:0;border-radius:999px;align-self:flex-start;align-items:center;gap:4px;margin:4px 0 2px 4px;padding:2px 8px;font-size:11px;line-height:16px;transition:opacity .1s;display:inline-flex}.e-Ux-W_root:hover .e-Ux-W_inspectButton,.e-Ux-W_inspectButton:focus-visible{opacity:1}.e-Ux-W_inspectButton:hover{background:var(--dsw-alias-interactive-bg-hover-solid);color:var(--dsw-alias-label-primary)}.e-Ux-W_bodyScroll{max-height:260px;overflow-y:auto}.e-Ux-W_ioCard{border:1px solid var(--dsw-alias-border-l1);background:var(--dsw-alias-markdown-code-block);font:var(--dsw-font-markdown-code-block-small);border-radius:12px;flex-direction:column;margin:4px 0 4px 4px;display:flex}.e-Ux-W_ioSection{grid-template-columns:max-content 1fr;align-items:baseline;column-gap:14px;max-height:150px;padding:12px 16px;display:grid;overflow-y:auto}.e-Ux-W_ioSection::-webkit-scrollbar-thumb{background-clip:padding-box;border:2px solid #0000;border-radius:6px}.e-Ux-W_ioSection::-webkit-scrollbar-track{margin:6px 0}.e-Ux-W_ioLabel{color:var(--dsw-alias-label-caption);align-self:start;position:sticky;top:0}.e-Ux-W_ioDivider{background:var(--dsw-alias-border-l2);flex:none;height:1px}.e-Ux-W_ioText{white-space:pre-wrap;word-break:break-word;min-width:0;color:var(--dsw-alias-label-secondary)}.e-Ux-W_ioText[data-error]{color:var(--dsw-alias-state-error-primary)}.e-Ux-W_codeBody,.e-Ux-W_terminalBody,.e-Ux-W_diffBody,.e-Ux-W_readBody,.e-Ux-W_searchBody,.e-Ux-W_webBody{margin:4px 0 4px 4px}.e-Ux-W_searchRecovery{white-space:pre-wrap;overflow-wrap:anywhere;font:var(--dsw-font-xs-13);color:var(--dsw-alias-label-tertiary);margin:4px 0 4px 4px}.e-Ux-W_codeBody{--dsl-code-block-content-font:var(--dsw-font-markdown-code-block-small)}.e-Ux-W_terminalBody{--dsl-terminal-font:var(--dsw-font-markdown-code-block-small);--dsl-terminal-line-height:18px;--dsl-terminal-output-max-height:224px;border:1px solid var(--dsw-alias-border-l1)}.e-Ux-W_visuallyHidden{clip:rect(0 0 0 0);white-space:nowrap;width:1px;height:1px;position:absolute;overflow:hidden}";
		...
		var ToolRow_module_css_default = {
			"bodyScroll": "e-Ux-W_bodyScroll",
			"bodyWrap": "e-Ux-W_bodyWrap",
			"chevron": "e-Ux-W_chevron",
			"codeBody": "e-Ux-W_codeBody",
			"diffBody": "e-Ux-W_diffBody",
			"dsh-tool-row-sweep": "e-Ux-W_dsh-tool-row-sweep",
			"errorSummary": "e-Ux-W_errorSummary",
			"fileLink": "e-Ux-W_fileLink",
			"inspectButton": "e-Ux-W_inspectButton",
			"ioCard": "e-Ux-W_ioCard",
			"ioDivider": "e-Ux-W_ioDivider",
			"ioLabel": "e-Ux-W_ioLabel",
			"ioSection": "e-Ux-W_ioSection",
			"ioText": "e-Ux-W_ioText",
			"leading": "e-Ux-W_leading",
			"readBody": "e-Ux-W_readBody",
			"root": "e-Ux-W_root",
			"row": "e-Ux-W_row",
			"searchBody": "e-Ux-W_searchBody",
			"searchRecovery": "e-Ux-W_searchRecovery",
			"sep": "e-Ux-W_sep",
			"summary": "e-Ux-W_summary",
			"summarySuffix": "e-Ux-W_summarySuffix",
			"terminalBody": "e-Ux-W_terminalBody",
			"title": "e-Ux-W_title",
			"visuallyHidden": "e-Ux-W_visuallyHidden",
			"webBody": "e-Ux-W_webBody"
		};
		//#endregion
		...
		*  summary already describe a settled row). */
		...
		//#endregion
		//#region \0dsh-css:/private/tmp/claude-501/-Users-alex-Documents-Code-dataelem-dsh-desktop/8cafdb41-dc87-41ba-bba5-9afd99a08420/scratchpad/harness/packages/client/ui-tool/src/client/tool/ToolCallTree.module.css.mjs
		const css$2 = ".LKFeyW_callRow{border-radius:6px}.LKFeyW_subCalls{border-left:1px solid var(--dsw-alias-border-l2);flex-direction:column;gap:4px;margin:4px 0 2px 22px;padding-left:8px;display:flex}";
		...
		var ToolCallTree_module_css_default = {
			"callRow": "LKFeyW_callRow",
			"subCalls": "LKFeyW_subCalls"
		};
		//#endregion
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:/private/tmp/claude-501/-Users-alex-Documents-Code-dataelem-dsh-desktop/8cafdb41-dc87-41ba-bba5-9afd99a08420/scratchpad/harness/packages/client/ui-tool/src/client/tool/ToolDetails.module.css.mjs
		const css$1 = ".UJIahW_description{color:var(--dsw-alias-label-secondary);font:var(--dsw-font-xs-13);margin:0 0 6px}.UJIahW_cardBody{margin:0}.UJIahW_recovery{white-space:pre-wrap;overflow-wrap:anywhere;color:var(--dsw-alias-label-tertiary);font:var(--dsw-font-xs-13);margin:6px 0 0}.UJIahW_code{background:var(--dsw-alias-markdown-code-block);font-family:var(--ds-font-family-code);color:var(--dsw-alias-label-primary);white-space:pre-wrap;word-break:break-word;border-radius:12px;margin:0;padding:16px;font-size:13px;line-height:22px}.UJIahW_code[data-error]{color:var(--dsw-alias-state-error-primary)}.UJIahW_read,.UJIahW_web{margin:0}.UJIahW_empty{color:var(--dsw-alias-label-tertiary);padding:8px 0;font-size:13px;line-height:20px}";
		...
		var ToolDetails_module_css_default = {
			"cardBody": "UJIahW_cardBody",
			"code": "UJIahW_code",
			"description": "UJIahW_description",
			"empty": "UJIahW_empty",
			"read": "UJIahW_read",
			"recovery": "UJIahW_recovery",
			"web": "UJIahW_web"
		};
		//#endregion
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:/private/tmp/claude-501/-Users-alex-Documents-Code-dataelem-dsh-desktop/8cafdb41-dc87-41ba-bba5-9afd99a08420/scratchpad/harness/packages/client/ui-tool/src/client/tool/toolviews/bash-sample.module.css.mjs
		const css = ".Gx6N5W_card{flex-direction:column;display:flex}.Gx6N5W_terminal{--dsl-terminal-font:var(--dsw-font-markdown-code-block-small);--dsl-terminal-line-height:18px;--dsl-terminal-output-max-height:224px;border:1px solid var(--dsw-alias-border-l1);margin:4px 0 4px 4px}.Gx6N5W_ioCard{border:1px solid var(--dsw-alias-border-l1);background:var(--dsw-alias-markdown-code-block);font:var(--dsw-font-markdown-code-block-small);border-radius:12px;flex-direction:column;margin:4px 0 4px 4px;display:flex}.Gx6N5W_ioSection{grid-template-columns:max-content 1fr;align-items:baseline;column-gap:14px;max-height:150px;padding:12px 16px;display:grid;overflow-y:auto}.Gx6N5W_ioSection::-webkit-scrollbar-thumb{background-clip:padding-box;border:2px solid #0000;border-radius:6px}.Gx6N5W_ioSection::-webkit-scrollbar-track{margin:6px 0}.Gx6N5W_ioLabel{color:var(--dsw-alias-label-caption);align-self:start;position:sticky;top:0}.Gx6N5W_ioDivider{background:var(--dsw-alias-border-l2);flex:none;height:1px}.Gx6N5W_ioText{white-space:pre-wrap;word-break:break-word;min-width:0;color:var(--dsw-alias-label-secondary)}.Gx6N5W_ioText[data-error]{color:var(--dsw-alias-state-error-primary)}.Gx6N5W_root[data-expandable]{cursor:pointer}.Gx6N5W_root{height:calc(24px + var(--dsh-content-font-delta,0px));align-items:center;min-width:0;display:flex;position:relative;overflow:hidden}.Gx6N5W_root[data-state=running]:after{content:\"\";background:linear-gradient(90deg, transparent 0%, color-mix(in srgb, var(--dsw-alias-bg-base) 60%, transparent) 55%, transparent 100%);pointer-events:none;width:300px;animation:2.6s ease-out infinite Gx6N5W_dsh-bash-row-sweep;position:absolute;top:0;bottom:0;left:0}@keyframes Gx6N5W_dsh-bash-row-sweep{0%{left:-300px}90%,to{left:100%}}.Gx6N5W_leading{width:calc(16px + var(--dsh-content-font-delta,0px));height:calc(16px + var(--dsh-content-font-delta,0px));color:var(--dsw-alias-label-tertiary);flex:none;justify-content:center;align-items:center;margin-right:6px;display:inline-flex;position:relative}.Gx6N5W_leading svg:not([data-state]){width:calc(14px + var(--dsh-content-font-delta,0px));height:calc(14px + var(--dsh-content-font-delta,0px))}.Gx6N5W_chevron{color:var(--dsw-alias-label-secondary)}.Gx6N5W_iconIdle{opacity:1;transition:opacity .1s;display:inline-flex}.Gx6N5W_chevronHover{opacity:0;margin:auto;transition:opacity .1s;position:absolute;inset:0}.Gx6N5W_root:hover .Gx6N5W_iconIdle{opacity:0}.Gx6N5W_root:hover .Gx6N5W_chevronHover{opacity:1}.Gx6N5W_title{font-size:var(--dsh-content-font-size-secondary,13px);line-height:calc(24px + var(--dsh-content-font-delta,0px));color:var(--dsw-alias-label-secondary);flex:none}.Gx6N5W_sep{background:var(--dsw-alias-label-caption);border-radius:1px;flex:none;width:2px;height:2px;margin:0 8px}.Gx6N5W_summary{text-overflow:ellipsis;white-space:nowrap;min-width:0;font-size:var(--dsh-content-font-size-secondary,13px);line-height:calc(24px + var(--dsh-content-font-delta,0px));color:var(--dsw-alias-label-tertiary);flex:auto;overflow:hidden}.Gx6N5W_errorSummary{color:var(--dsw-alias-state-error-primary)}.Gx6N5W_bodyWrap{flex-direction:column;display:flex}.Gx6N5W_inspectButton{border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-base);color:var(--dsw-alias-label-secondary);cursor:pointer;opacity:0;border-radius:999px;align-self:flex-start;align-items:center;gap:4px;margin:4px 0 2px 4px;padding:2px 8px;font-size:11px;line-height:16px;transition:opacity .1s;display:inline-flex}.Gx6N5W_card:hover .Gx6N5W_inspectButton,.Gx6N5W_inspectButton:focus-visible{opacity:1}.Gx6N5W_inspectButton:hover{background:var(--dsw-alias-interactive-bg-hover-solid);color:var(--dsw-alias-label-primary)}.Gx6N5W_visuallyHidden{clip:rect(0 0 0 0);white-space:nowrap;width:1px;height:1px;position:absolute;overflow:hidden}";
		...
		var bash_sample_module_css_default = {
			"bodyWrap": "Gx6N5W_bodyWrap",
			"card": "Gx6N5W_card",
			"chevron": "Gx6N5W_chevron",
			"chevronHover": "Gx6N5W_chevronHover",
			"dsh-bash-row-sweep": "Gx6N5W_dsh-bash-row-sweep",
			"errorSummary": "Gx6N5W_errorSummary",
			"iconIdle": "Gx6N5W_iconIdle",
			"inspectButton": "Gx6N5W_inspectButton",
			"ioCard": "Gx6N5W_ioCard",
			"ioDivider": "Gx6N5W_ioDivider",
			"ioLabel": "Gx6N5W_ioLabel",
			"ioSection": "Gx6N5W_ioSection",
			"ioText": "Gx6N5W_ioText",
			"leading": "Gx6N5W_leading",
			"root": "Gx6N5W_root",
			"sep": "Gx6N5W_sep",
			"summary": "Gx6N5W_summary",
			"terminal": "Gx6N5W_terminal",
			"title": "Gx6N5W_title",
			"visuallyHidden": "Gx6N5W_visuallyHidden"
		};
		//#endregion
