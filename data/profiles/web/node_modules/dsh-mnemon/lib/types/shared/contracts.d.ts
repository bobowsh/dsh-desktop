...
export type MemoryProviderId = 'mnemon-native' | 'openviking' | 'honcho' | 'mem0' | 'hindsight' | 'holographic' | 'retaindb' | 'byterover' | 'supermemory';
...
export interface UpdateMemoryBodyRequest {
    ...
    connection?: MemoryProviderConnection;
    clearSecrets?: string[];
    openViking?: Partial<OpenVikingBodyConnection> & {
        clearApiKey?: boolean;
    };
}
