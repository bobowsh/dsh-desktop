						...
						children: [
							...
							/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
								...
								children: [catalog?.items.map((body) => /* @__PURE__ */ (0, react_jsx_runtime.jsx)("article", {
									...
									"data-reconnectable": props.writeEnabled || void 0,
									...
									tabIndex: props.writeEnabled ? 0 : void 0,
									"aria-label": props.writeEnabled ? t("overview.reconnectAria", { name: body.name }) : void 0,
									title: reconnectingBody === body.id ? t("overview.reconnecting") : body.error ?? (props.writeEnabled ? t("overview.reconnectHint") : void 0),
									onClick: (event) => {
