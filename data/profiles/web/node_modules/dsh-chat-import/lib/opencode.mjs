...
// 参数化（默认 opencode.db），读取/导入编排完全复用。
export async function importOpencodeDirectory(ctx, dirTarget, args, { registryDir, persisted, runDecision, markTrimmedSource, dbName = 'opencode.db' } = {}) {
