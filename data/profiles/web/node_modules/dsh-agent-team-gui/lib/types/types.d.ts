...
export declare function AgentId(value: string): AgentId;
...
export declare function SquadId(value: string): SquadId;
...
export declare function DispatchId(value: string): DispatchId;
...
export interface AgentTeamImportPreview {
    ...
    readonly conflicts: {
        ...
        readonly squadIds: SquadId[];
    };
    readonly affectedSquads: Array<{
        readonly squadId: SquadId;
        readonly squadName: string;
        readonly agentIds: AgentId[];
    }>;
