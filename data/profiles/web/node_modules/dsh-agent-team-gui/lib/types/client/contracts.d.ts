...
export declare const AGENT_TEAM_RPC_API_VERSION = 3;
...
export type NextOverride = 'inherit' | 'solo' | {
    squadId: string;
    squadName: string;
} | null;
...
export declare const EMPTY_USAGE: TokenUsageView;
...
export declare const EMPTY_DATA: TeamSnapshot;
